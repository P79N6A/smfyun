...
//分销宝收益明细
class Model_qwt_fxbScore extends ORM {
    ...
    protected $_belongs_to = array(
        'trade'  => array('model' => 'qwt_fxbtrade', 'foreign_key' => 'tid'), //订单
        'qrcode'  => array('model' => 'qwt_fxbqrcode', 'foreign_key' => 'qid'), //订单
    );
    ...
    public function scoreIn($user, $type, $score, $rid=0, $tid=0)
    {
        ...
        //结算时间：T+10
        $trade = ORM::factory('qwt_fxbtrade', $tid);
        if ($trade->id) {
