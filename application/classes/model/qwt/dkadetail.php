...
//分销宝收益明细
class Model_qwt_dkadetail extends ORM {
    ...
    protected $_belongs_to = array(
        'trade'  => array('model' => 'qwt_dkatrade', 'foreign_key' => 'tid'), //订单
        'qrcode'  => array('model' => 'qwt_dkaqrcode', 'foreign_key' => 'qid'), //订单
    );
    ...
    public function cashIn($user, $type, $cash, $rid=0, $tid=0)
    {
        ...
        //结算时间：T+10
        $trade = ORM::factory('qwt_dkatrade', $tid);
        if ($trade->id) {
