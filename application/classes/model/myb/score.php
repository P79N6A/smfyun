...
//分销宝收益明细
class Model_Myb_Score extends ORM {
    ...
    protected $_belongs_to = array(
        'trade'  => array('model' => 'myb_trade', 'foreign_key' => 'tid'), //订单
        'qrcode'  => array('model' => 'myb_qrcode', 'foreign_key' => 'qid'), //订单
    );

    public function getTypeName($id)
    {
        $types = array(0=>'收入', 1=>'购买奖励', 2=>'直接推广收益', 3=>'间接推广收益', 4=>'提现', 5=>'支出', 6=>'关注奖励', 7=>'扫码奖励', 8=>'间接扫码奖励',9=>'手动企业付款结算',10=>'手动结算');
        return $types[$id];
    }
    ...
    public function scoreIn($user, $type, $score, $rid=0, $tid=0,$bz='')
    {
        ...
        //结算时间：T+10
        $trade = ORM::factory('myb_trade', $tid);
        if ($trade->id) {
