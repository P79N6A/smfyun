...
//分销宝收益明细
class Model_Yty_Score extends ORM {
    ...
    protected $_belongs_to = array(
        'trade'  => array('model' => 'yty_trade', 'foreign_key' => 'tid'), //订单
        'qrcode'  => array('model' => 'yty_qrcode', 'foreign_key' => 'qid'), //订单
    );
    ...
    public function scoreIn($user, $type, $score, $rid=0, $tid=0)
    {
        ...
        //结算时间：T+10
        $trade = ORM::factory('yty_trade', $tid);
        if ($trade->id) {
