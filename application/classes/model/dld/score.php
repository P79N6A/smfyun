...
//分销宝收益明细
class Model_dld_Score extends ORM {
    ...
    protected $_belongs_to = array(
        'trade'  => array('model' => 'dld_trade', 'foreign_key' => 'tid'), //订单
        'qrcode'  => array('model' => 'dld_qrcode', 'foreign_key' => 'qid'), //订单
    );
    ...
    public function scoreIn($user, $type, $score, $rid=0, $tid=0,$bz='')
    {
        ...
        //结算时间：T+10
        $trade = ORM::factory('dld_trade', $tid);
        if ($trade->id) {
