...
//分销宝收益明细
class Model_wzb_Score extends ORM {
    ...
    protected $_belongs_to = array(
        'trade'  => array('model' => 'wzb_trade', 'foreign_key' => 'tid'), //订单
        'qrcode'  => array('model' => 'wzb_qrcode', 'foreign_key' => 'qid'), //订单
    );
    ...
    public function scoreIn($user, $type, $score, $rid=0, $tid=0)
    {
        ...
        //结算时间：T+10
        $trade = ORM::factory('wzb_trade', $tid);
        if ($trade->id) {
