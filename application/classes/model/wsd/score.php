...
//分销宝收益明细
class Model_wsd_Score extends ORM {
    ...
    protected $_belongs_to = array(
        'trade'  => array('model' => 'wsd_trade', 'foreign_key' => 'tid'), //订单
        'qrcode'  => array('model' => 'wsd_qrcode', 'foreign_key' => 'qid'), //订单
    );
    ...
    public function scoreIn($user, $type, $score, $rid=0, $tid=0,$bz='')
    {
        ...
        //结算时间：T+10
        $trade = ORM::factory('wsd_trade', $tid);
        if ($trade->id) {
