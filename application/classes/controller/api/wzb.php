...
Class Controller_Api_wzb extends Controller_API {
    ...
    public function action_post($appid='', $debug=0)
    {
        ...
        if ($biz->expiretime && strtotime($biz->expiretime) < time()) $txtReply = '您的神码云直播插件已过期！在有赞后台-概况-微信-插件中心，关闭对应的插件即可取消本提示；如需继续使用，请联系第三方续费。';
