...
Class Controller_Api_wdbticket extends Controller_API {
    ...
    var $Keyword;
    var $access_token;
    // var $baseurl = 'http://jfb.smfyun.com/wdb/';
    ...
    public function action_post()
    {
        ...
        Kohana::$log->add('wdbticket:postdata', print_r($encryptMsg, true));
        ...
        if ($errCode == 0) {
            ...
            Kohana::$log->add('wdbticket:encrypt', print_r($encrypt, true));
            Kohana::$log->add('wdbticket:nonce', print_r($nonce, true));
            Kohana::$log->add('wdbticket:msg_sign', print_r($msg_sign, true));
            Kohana::$log->add('wdbticket:错误码', print_r($errCode, true));
        }
        echo 'success';
    }
