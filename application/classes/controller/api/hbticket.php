...
Class Controller_Api_hbticket extends Controller_API {
    ...
    public function action_get($bid=1)
    {
        ...
        if ($this->checkSignature() == true)
            ...
            die($config['name']."红包宝 by 1nnovator");
    }
    ...
    public function action_post()
    {
        ...
        Kohana::$log->add('hbticket:postdata', print_r($encryptMsg, true));
        ...
        if ($errCode == 0) {
            ...
            Kohana::$log->add('hbticket:错误码', print_r($errCode, true));
        }
        echo 'success';
    }
