...
// wx963d1a274a56374f
// d75702999482039a1b56ed83eed59003
class Controller_bnk extends Controller_Base{
  ...
  public function action_payfee(){
      ...
      if($user->score>=$_GET['fee']){
          ...
          $body = "充值余额";
          $total_fee = floatval(($total_fee-$user->score)*100);
  ...
  public function action_qr($oid){
      ...
      $wx['appid']='wx963d1a274a56374f';
      $wx['appsecret']='d75702999482039a1b56ed83eed59003';
      require_once Kohana::find_file('vendor', 'weixin/wechat.class');
      $we = new wechat($wx);
      $qr = $we->getxcx_qr('pid=6','pages/hbdetail/index');
      echo '<pre>';
      var_dump($qr);
      exit;
  }
