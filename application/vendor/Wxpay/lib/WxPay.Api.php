...
require_once Kohana::find_file('vendor/Wxpay', 'lib/WxPay.Exception');
require_once Kohana::find_file('vendor/Wxpay', 'lib/WxPay.Config');
require_once Kohana::find_file('vendor/Wxpay', 'lib/WxPay.Data');
/**
 *
