		...
		<div class="aui-page">
			...
			<div class="aui-text-top aui-l-content aui-l-content-clear">
				...
				<div class="aui-menu-list aui-menu-list-clear">
					<ul>
						<?foreach ($msg as $k => $v):
						$headimgurl = ORM::factory('sqb_qrcode')->where('id','=',$v->tid)->find()->headimgurl;
						$nickname = ORM::factory('sqb_qrcode')->where('id','=',$v->tid)->find()->nickname;
						?>
						<li class="b-line">
							<a href="../sqb/liaotian/<?=$v->tid?>">
