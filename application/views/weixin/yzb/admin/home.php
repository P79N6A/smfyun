    ...
    <div class="col-xs-12">
      ...
      <div class="nav-tabs-custom">
        ...
        <ul class="nav nav-tabs">
          ...
          <li id="cfg_cancle_li"><a href="#cfg_cancle" data-toggle="tab">取消关注扣积分</a></li> -->
        </ul>
        ...
        <div class="tab-content">
          <div class="tab-pane" id="cfg_yz">
            <div class="callout callout-success">
              ...
              <p><b>插件 url：</b> <u><?='http://'.$_SERVER["HTTP_HOST"].'/api/yzb/'.$_SESSION['yzba']['user'];?></u></p>
            ...
            <form role="form" method="post">
              <div class="box-body">
                ...
                <?php if($oauth==1):?>
                  <div class="lab4">
                    <a href='/yzba/oauth'><button type="button" class="btn btn-warning">点击一键授权有赞</button></a>
                  </div>
                  <br>
                  <?else:?>
                  <div class="lab4">
                    <a href='/yzba/oauth'><button type="button" class="btn btn-warning">点击重新授权有赞</button></a>
                  </div>
                  <?endif?>
              </div>
          ...
          <div class="tab-pane" id="cfg_text">
            ...
            <form role="form" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                if ($result['tpl']):
                  ?>
                <div class="form-group">
                  <a href="/yzba/images/cfg/<?=$result['tpl']?>.v<?=time()?>.jpg" target="_blank"><img class="img-thumbnail" src="/yzba/images/cfg/<?=$result['tpl']?>.v<?=time()?>.jpg" width="200" title="点击查看原图"></a>
                </div>
              <?php endif?>
              ...
              <div class="form-group">
                ...
                <p class="help-block">只能为 JPEG 格式，规格建议为 640*900px，最大不超过 300K，<a href="/yzb/tpl.zip" target="_blank">点击这里</a> 下载 PSD 模板自行设计。</p>
              </div>
              ...
              if ($result['tplhead']):
                ?>
              <div class="form-group">
                <a href="/yzba/images/cfg/<?=$result['tplhead']?>.v<?=time()?>.jpg" target="_blank"><img class="img-thumbnail" src="/yzba/images/cfg/<?=$result['tplhead']?>.v<?=time()?>.jpg" width="100" title="点击查看原图"></a>
              </div>
            <?php endif?>
            ...
            <div class="tab-pane" id="cfg_zero">
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          ...
                          <a href="<?php echo URL::site("yzba/empty")?>?DELETE=1" class="btn btn-outline">确认清空</a>
                        </div>
                      </div><!-- /.modal-content -->
                    </div><!-- /.modal-dialog -->
                  </div><!-- /.modal -->
              ...
              <div class="tab-pane" id="cfg_area">
                ...
                <!-- // <script src="/yzb/plugins/jQuery/jquery.js"></script> -->
                <script src="http://cdn.jfb.smfyun.com/yzb/plugins/citySelect/jquery.cityselect.js"></script>
                <script src="/yzb/plugins/citySelect/city.min1.js"></script>
                <script type="text/javascript">
                  $("#city1").citySelect({
                    prov:'',
                    city:'',
