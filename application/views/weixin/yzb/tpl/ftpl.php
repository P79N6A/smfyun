...
/*.text_menu
{
  ...
  <script src="http://cdn.jfb.smfyun.com/wdy/plugins/jQuery/jQuery-2.1.4.min.js"></script>
    ...
    <div class="wrp">
      ...
      <div class="profile_fun">
            ...
            <ul id="js_menu" class="menu_list">
                <? if(Session::instance()->get('wdy')["bid"]==582):?>
                <li class="menu_item fans_record" style="width:50%">
                    <a href="/wdy/score" class="inner_item">
                ...
                <li class="menu_item rank_record" style="width:50%">
                    <a href="/wdy/top" class="inner_item">
                        <span class="icon_menu"></span>
              ...
              <? else:?>
                ...
                <li class="menu_item swap_record">
                    <a href="/wdy/items" class="inner_item">
                        <span class="icon_menu"></span>
