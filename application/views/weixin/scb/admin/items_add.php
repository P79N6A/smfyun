<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="/scba/items">奖品管理</a></li>
    ...
    <div class="box-body">
      ...
      <div class="form-group">
        ...
        <?php if ($result['action'] == 'edit' && $result['item']['pic']):?>
          <div class="form-group"><img class="img-thumbnail" src="/scba/images/item/<?=$result['item']['id']?>.v<?=$result['item']['lastupdate']?>.jpg" width="100"></div>
