...
body{
 margin: 0px;
 padding: 0px;
 background: url(/sns/img/timeout.png) top no-repeat;
...
$('.join').click(function() {
  window.location.replace('http://wqs.jd.com/promote/201703/stocking.shtml?ptag=17018.208.4');
});
</script>
</html>
