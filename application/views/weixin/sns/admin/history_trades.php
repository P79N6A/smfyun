...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="/qfxa/qrcodes">订单记录</a></li>
        ...
        <div class="box box-success">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                $fid = ORM::factory('qfx_score')->where('tid', '=', $v->id)->where('type', '=', 2)->find();
                $fuser = ORM::factory('qfx_qrcode')->where('id', '=', $fid->qid)->find();
                ...
                <tr>
                  ...
                  <td><?=$v->payment?></td>
                  <td><?=$v->pay_time?></td>
                  <td><a href="/qfxa/qrcodes?id=<?=$fuser->id?>"><?=$fuser->nickname?></a></td>
                  <td><?=$v->money1?></td>
                </tr>
