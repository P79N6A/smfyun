          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="cfg_yz">
                ...
                <div class="callout callout-success">
                  <h4>有赞插件配置信息</h4>
                  <p><b>插件 url：</b> <u><?='http://'.$_SERVER["HTTP_HOST"].'/api/fxb/'.$_SESSION['fxba']['user'];?></u></p>
                ...
                <form role="form" method="post">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="scene_id" placeholder="输入带参数二维码的 scene_id"  name="cfg[scene_id_fxb]" value="<?=$config['scene_id_fxb']?>">
                    </div>
                    <p class="alert alert-danger alert-dismissable">注意：请务必点击有赞一键授权，否则功能将无法使用</p>
                    <?php if($oauth==1):?>
                  <div class="lab4">
                    <a href='/fxba/oauth'><button type="button" class="btn btn-warning">点击一键授权有赞</button></a>
                  </div>
                  <br>
                  <?else:?>
                  <div class="lab4">
                    <a href='/fxba/oauth'><button type="button" class="btn btn-warning">点击重新授权有赞</button></a>
                  </div>
                  <?endif?>
                  ...
                  <div class="box-body">
                    ...
                    <div class="col-lg-3 col-sm-3">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="menu0" placeholder="生成海报" maxlength="10" name="menu[key_fxbqrcode]" value="<?=$config['key_fxbqrcode']?>">
                      </div>
                    </div>
                    </div>
                    ...
                    <div class="col-lg-8">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="menu1" placeholder="我的收益" maxlength="10" name="menu[key_fxbscore]" value="<?=$config['key_fxbscore']?>">
                      </div>
                    </div>
                    </div>
                    ...
                    <div class="col-lg-8">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="menu2" maxlength="10" value="<?='http://'.$_SERVER["HTTP_HOST"].'/fxb/index_oauth/'.$_SESSION['fxba']['bid'].'/home'?>">
                      </div>
                    </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-lg-3 col-sm-3">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="menu10" placeholder="自定义 KEY1" maxlength="10" name="menu[key_c1_fxb]" value="<?=$config['key_c1_fxb']?>">
                        </div>
                      </div>
                     <div class="col-lg-9 col-sm-9">
                        <div class="form-group">
                          <label for="v10">点击后回复文字（使用 \n 换行）</label>
                          <input type="text" class="form-control" id="v10" placeholder="点击自定义 KEY1 后的回复文字" maxlength="200" name="menu[value_c1_fxb]" value="<?=$config['value_c1_fxb']?>">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-lg-3 col-sm-3">
                        <div class="form-group">
                          <input type="text" class="form-control" id="menu11" placeholder="自定义 KEY2" maxlength="10" name="menu[key_c2_fxb]" value="<?=$config['key_c2_fxb']?>">
                        </div>
                      </div>
                     <div class="col-lg-9 col-sm-9">
                        <div class="form-group">
                          <input type="text" class="form-control" id="v11" placeholder="点击自定义 KEY2 后的回复文字" maxlength="200" name="menu[value_c2_fxb]" value="<?=$config['value_c2_fxb']?>">
                        </div>
                      </div>
                    </div>
                   ...
                   <div class="row">
                      <div class="col-lg-3 col-sm-3">
                        <div class="form-group">
                          <input type="text" class="form-control" id="menu12" placeholder="自定义 KEY3" maxlength="10" name="menu[key_c3_fxb]" value="<?=$config['key_c3_fxb']?>">
                        </div>
                      </div>
                     <div class="col-lg-9 col-sm-9">
                        <div class="form-group">
                          <input type="text" class="form-control" id="v12" placeholder="点击自定义 KEY3 后的回复文字" maxlength="200" name="menu[value_c3_fxb]" value="<?=$config['value_c3_fxb']?>">
                        </div>
                      </div>
                    </div>
            ...
            <div class="tab-pane" id="cfg_text">
                ...
                <form role="form" method="post" enctype="multipart/form-data">
                  ...
                  <div class="alert alert-danger">海报设置</div>
                    ...
                    ?>
                    <div class="form-group">
                      <a href="/fxba/images/cfg/<?=$result['tpl']?>.v<?=time()?>.jpg" target="_blank"><img class="img-thumbnail" src="/fxba/images/cfg/<?=$result['tpl']?>.v<?=time()?>.jpg" width="200" title="点击查看原图"></a>
                    </div>
                    <?php endif?>
                    ...
                    ?>
                    <div class="form-group">
                      <a href="/fxba/images/cfg/<?=$result['tplhead']?>.v<?=time()?>.jpg" target="_blank"><img class="img-thumbnail" src="/fxba/images/cfg/<?=$result['tplhead']?>.v<?=time()?>.jpg" width="100" title="点击查看原图"></a>
                    </div>
                    <?php endif?>
                    ...
                    <div class="row">
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" min="1" max="30" class="form-control" id="ticket_lifetime" name="text[fxb_ticket_lifetime]" value="<?=intval($config['fxb_ticket_lifetime'])?>">
                      </div>
                      </div>
                    ...
                    <div class="alert alert-danger">佣金及提现设置</div>
                     ...
                     <div class="form-group">
                      <label for="fxb_kaiguan">三级收益开关</label>
                    ...
                    <div class="form-group">
                      <label for="fxb_haibao">未购买用户生成海报？</label>
                      <div class="radio">
                ...
                <div class="alert alert-warning">风险控制：超过以下警戒值的用户，会被锁定不能领取奖品。具体说明请参见说明书，建议谨慎设置。</div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      <label for="fxb_url">常见问题说明网址</label>
                      <input type="text" class="form-control" id="fxb_url" name="text[fxb_url]" placeholder="http://" value="<?=$config['fxb_url']?>">
                      <p class="help-block">建议设置为常见问题的微杂志</p>
                    </div>

                    <div class="form-group">
                      <label for="fxb_desc">扫码后推送文案</label>
                      <textarea class="form-control" id="fxb_desc" name="text[fxb_desc]"><?=$config['fxb_desc']?></textarea>
                    </div>

                    <div class="form-group">
                      <label for="fxb_money_desc">活动说明文案</label>
                      <textarea class="form-control" id="fxb_money_desc" name="text[fxb_money_desc]" style="height:150px"><?=htmlspecialchars($config['fxb_money_desc'])?></textarea>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="send" name="text[text_fxbsend]" placeholder="您的专属海报生成中，请稍等..." value="<?=htmlspecialchars($config['text_fxbsend'])?>">
                    </div>
