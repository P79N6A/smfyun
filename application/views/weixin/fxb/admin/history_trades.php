...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="/fxba/qrcodes">订单记录</a></li>
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                //   $fuser = ORM::factory('fxb_qrcode')->where('bid', '=', $v->bid)->where('openid', '=', $v->fopenid)->find();
                  //$information=ORM::factory('fxb_qrcode',array('id'=>$v->qid,'bid'=>$v->bid))->find();
                $information=ORM::factory('fxb_qrcode')->where('id','=',$v->qid)->find();
                $fid = ORM::factory('fxb_score')->where('tid', '=', $v->id)->where('type', '=', 2)->find();
                $fuser = ORM::factory('fxb_qrcode')->where('id', '=', $fid->qid)->find();
