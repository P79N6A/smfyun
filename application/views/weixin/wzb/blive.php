...
<body style="margin: 0px auto; font-size: 12px;" class="mui-android mui-android-6 mui-android-6-0">
    ...
    <figure id="video-box" class="vod-box-pl" style="height: 568px;">
        <video x5-video-player-type="h5" x5-video-player-fullscreen="true" style="background: rgb(0, 0, 0);" id="video" loop="loop" width="100%" preload="auto" poster="" webkit-playsinline="true" playsinline="true" x-webkit-airplay="true" src="http://wscdn.alhls.xiaoka.tv/201753/9e1/f9c/R2ZWUMTk2FgOC02Z/index.m3u8"></video>
        <div class="videobg" style="position: absolute; width: 100%; height: 100%; top: 0px; background-image: url(&quot;https://alcdn.img.xiaoka.tv/20170428/b3b/913/50606454/b3b913630db108f5658fd10ea4da173a.jpg@1e_1c_0o_0l_640h_640w.webp&quot;); background-position: center center; background-size: cover; display: none;"></div>
        ...
        <section class="yizhibo-logo">
            <div class="yizhibo-logo-ctn">
                <span>直播ID:<?=$result['sid']?></span>
            </div>
        </section>
        <div class="live-starttime"> <?=date('Y-m-d',time())?></div>
            ...
            <div class="left-side-cartoon">
                <div class="effect hide" data-amount="14" id="" data-current="14" style="margin-left: -8rem;">
                    <div class="wrap-cartoon">
                        ...
                        <figure class="gift"> <img src="../live_test2/file/822ba53167ca5ff3864236a9b792723f.png"> </figure>
                        <h4 class="count">×&nbsp;14</h4> </div>
                </div>
                <div class="effect hide" data-amount="1" id="" data-current="1" style="margin-left: -8rem;">
                    <div class="wrap-cartoon">
                        <figure class="cartoon-avatar"> <img src="../live_test2/file/41a6d60e3ced1015c1c3ee282e09ef1a.jpg"> </figure>
        ...
        <section class="btm-menu">
            <div class="wrap-menu">
                <div class="w-input ">
                    <input class="input" id="content" type="text" placeholder="说点什么吧...">
                </div>
                <figure class="cut"></figure>
                <span class="send-msg">发送</span>
                <div class="w-share">
                    <figure class="vs-share"><img src="../live_test2/file/shopping.png"></figure>
                </div>
                <!-- <div class="w-gift">
    ...
    <div class="guide-pay" style="display:none">
        <figure>
            <img src="../live_test2/file/guide_16ba045.png">
            <div class="close"></div>
        </figure>
    </div>
    <div class="login">
...
<div class="trolley" style="display:none;overflow: hidden; position: absolute; z-index: 1000; background: white; bottom: 0px; left: 0px; right: 0px; visibility: visible; transform: translate3d(0px, 0px, 0px); transition: all 300ms ease; opacity: 1;">
    ...
    wx.config({
        ...
        appId: 'wxd0d73c8619d8e64d', // 必填，公众号的唯一标识
        timestamp: 1493777596, // 必填，生成签名的时间戳
        nonceStr: 'R2ZWUMTk2FgOC02Z', // 必填，生成签名的随机串
        signature: '01c1631ccc9f5063fa7ddb9a87414086ad991318', // 必填，签名，见附录1
        jsApiList: ['onMenuShareTimeline', 'onMenuShareAppMessage', 'onMenuShareQQ', 'onMenuShareWeibo', 'onMenuShareQZone'] // 必填，需要使用的JS接口列表，所有JS接口列表见附录2
    });
    var shareConfig = {
            wx: {
                title: '#新人主播求关注#  #真爱粉在哪里？# hi,骚年，我在一直播@你，来🍼酸奶妹妹呀丶(50606454)的直播间一起互撩吧！',
                desc: '🍼酸奶妹妹呀丶(50606454)的直播、一直播-人生这场戏，执着演下去，最好玩的视频直播一直播来了,自带美颜美妆功能的拍摄神器！',
                imgUrl: 'https://alcdn.img.xiaoka.tv/20170428/b3b/913/50606454/b3b913630db108f5658fd10ea4da173a.jpg@1e_1c_0o_0l_166h_166w',
                link: "http://m.yizhibo.com/l/R2ZWUMTk2FgOC02Z.html"
            },
            sObj: {
    ...
    $(document).on('click', '.goods-pick', function(event) {
