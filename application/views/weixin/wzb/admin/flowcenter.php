    ...
    <div class="col-xs-12">
      ...
      <div class="nav-tabs-custom">
          ...
          <ul class="nav nav-tabs">
            <li id="cfg_yz_li" class="active"><a data-toggle="tab">购买流量</a></li>
            <li id="cfg_wx_li"><a data-toggle="tab">流量消耗记录</a></li>
          </ul>

          <script>
    $(document).on('click','#cfg_yz_li',function(){
      // $('#cfg_wx_li,#cfg_wx').removeClass('active');
      // $('#cfg_yz_li,#cfg_yz').addClass('active');
    });
    $(document).on('click','#cfg_wx_li',function(){
      window.location.href = '/wzba/flowcenter_history';
    });
          </script>
...
<form method="get" name="loginsform">
  ...
  <div class="row">
    <div class="col-xs-12" style="margin-left:25px;padding-top:10px;border-top:1px solid #f4f4f4;width:300px;">
      <a id="flowperchase" class="btn btn-success pull-left" style="margin-bottom:10px;"> <span>购买流量</span></a>
      <a id="caculator" class="btn btn-success pull-left" style=";margin-bottom:10px;margin-left:92px;"> <span>流量计算器</span></a>
    </div>
  </div>
...
<div class="mask caculator" style="display:none">
  <div class="payment">
    ...
    <div class="payment-bd" style="text-align:left; margin-left:100px;">
      <span>直&nbsp;&nbsp;&nbsp;播&nbsp;&nbsp;时&nbsp;&nbsp;长：</span>
      <input id='live-length' class="flownum" type="text" onkeyup="value=value.replace(/[^\d]/g,'') " ></input>
      <span>分钟</span>
    </div>
    <div class="payment-lg" style="text-align:left; margin-left:100px;">
      <span>同时在线人数：</span>
      <input id='live-num' class="flownum" type="text" onkeyup="value=value.replace(/[^\d]/g,'') " ></input>
      <span>人</span>
    </div>
    <div class="payment-bd" style="text-align:left; margin-left:100px;">
    ...
    <div class="payment-bd" style="text-align:left; margin-left:100px;">
      <a class="btn btn-success pull-left" onclick="get_caculate()"> <span>确定</span></a>
    </div>
