          ...
          <div class="tab-content">
            ...
            <div class="tab-pane active" id="cfg_text">
                <form role="form" method="post" enctype="multipart/form-data">
                  <div class="box-body">
                   <img class="qrcode" src="http://<?=$_SERVER["HTTP_HOST"]?>/wzb/img/qrcode_ios.jpg">
                   <div class="android">苹果版<span class="subtext">(for IOS)</span></div>
                  </div><!-- /.box-body -->
                </form>
            </div>
            <div class="box-footer">扫码前往App Store下载(或在App Store应用商店搜索“神码云直播”)</div>
          </div>
      </div>
