...
<html>
  <head>
    ...
    <title><?=$title?> | <?=$config['name']?> | 谁在用iPhone X</title>
  ...
  <body class="hold-transition skin-green sidebar-mini">
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <!-- Logo -->
        <a href="/sjba/orders" class="logo">
          <span class="logo-mini"><b>iPhone X</b></span>
          <span class="logo-lg"><i class="fa fa-wechat"></i>&nbsp;<b>谁在用iPhone X</b></span>
        </a>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="<?=isActive('orders')?>"><a href="/sjba/orders"><i class="fa fa-bar-chart"></i> <span>购买记录</span> </a></li>
          </ul><!-- /.sidebar-menu -->
        </section>
        <!-- /.sidebar -->
      </aside>
