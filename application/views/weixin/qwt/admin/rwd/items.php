...
?>
        ...
        <div class="tpl-content-wrapper">
            ...
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    ...
                    <div class="caption font-green bold">
                        ...
                        <a href="/qwtrwda/items/add" class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"></span> 添加新奖品</a>
                        </div>
            ...
            <button class="am-btn  am-btn-default am-btn-success tpl-am-btn-success am-icon-search" type="submit"></button>
                ...
                <tr>
                  ...
                  <td nowrap="">
                  <a style="background-color:#fff;" class='edit am-btn am-btn-default am-btn-xs am-text-secondary' href="/qwtrwda/items_edit/<?=$item->id?>"><span class="am-icon-pencil-square-o"></span> 修改</a>
  ...
  swal({
    ...
    function(){
      window.location.href = "/qwtrwda/items_delete/"+id;
    })
  })
    </script>
