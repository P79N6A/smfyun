    ...
    <div class="tpl-content-wrapper">
      ...
      <?php else:?>
        ...
        <?php if ($result['action'] == 'edit' && $item['pic']):?>
            <a href="/qwtrwda/images/item/<?=$result['item']['id']?>.v<?=$item['lastupdate']?>.jpg" target="_blank">
                                            <div class="tpl-form-file-img">
                                            <img class="img-thumbnail" src="/qwtrwda/images/item/<?=$result['item']['id']?>.v<?=$item['lastupdate']?>.jpg" width="100">
                                            </div>
                                            </a>
                                          <?php endif?>
...
function change(i){
  ...
  swal({
    ...
    function(){
      window.location.href = "/qwtrwda/items_delete/<?=$result['item']['id']?>";
    })
  })
 $(function() {
