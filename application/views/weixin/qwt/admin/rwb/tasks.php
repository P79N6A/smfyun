        ...
        <div class="tpl-content-wrapper">
            ...
            <button class="am-btn  am-btn-default am-btn-success tpl-am-btn-success am-icon-search" type="submit"></button>
                ...
                <tr>
                  ...
                  <td nowrap="">
                  <a style="background-color:#fff;" class='edit am-btn am-btn-default am-btn-xs am-text-secondary' href="/qwtrwba/tasks/edit/<?=$task->id?>"><span class="am-icon-pencil-square-o"></span> 修改</a>
