        ...
        <div class="tpl-content-wrapper">
          ...
          <?php endif?>
            <div class="tpl-content-scope">
                ...
                if ($result['tpl']):
                  ?>
                  <a href="/qwtrwba/images/cfg/<?=$result['tpl']?>.v<?=time()?>.jpg" target="_blank">
                                            <div class="tpl-form-file-img">
                                                <img src="/qwtrwba/images/cfg/<?=$result['tpl']?>.v<?=time()?>.jpg" alt="" title="点击查看原图">
                                            </div>
                                            </a>
                                          <?php endif?>
...
<div id="file-pic" style="display:inline-block;"></div>
                                        ...
                                        <small>
                                        只能为 JPEG 格式，规格建议为 640*900px，最大不超过 400K，<a href="/rwb/tpl.zip" target="_blank">点击这里</a> 下载 PSD 模板自行设计。</small>
              ...
              <?php
                    //默认头像
              if ($result['tplhead']):
                ?><a href="/qwtrwba/images/cfg/<?=$result['tplhead']?>.v<?=time()?>.jpg" target="_blank">
                                            <div class="tpl-form-file-img">
                                                <img class="avator" src="/qwtrwba/images/cfg/<?=$result['tplhead']?>.v<?=time()?>.jpg" alt="">
                                            </div>
                                            </a>
                                          <?php endif?>
                                        <div class="am-form-group am-form-file">
...
<script type="text/javascript">
  swal({
    ...
    function(isConfirm){
      if (isConfirm) {
           window.location.href = "http://<?=$_SERVER['HTTP_HOST']?>/qwta/product/4";
      }
  })
</script>
<?endif?>
