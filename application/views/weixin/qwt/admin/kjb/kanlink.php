                    ...
                    <div class="am-g">
                        <div class="tpl-form-body am-form-horizontal">
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="form-control" id="khv" name="shop[name]" value="http://kanjia.smfyun.com/smfyun/user_snsapi_userinfo/<?=$bid?>/kjb/list" readonly="">
