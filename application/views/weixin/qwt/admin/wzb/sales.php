...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="/qwtwzba/qrcodes">销售管理</a></li>
           ...
           <!-- <div class="input-group-btn add88">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <?php
                foreach ($orders as $o):
                 $biz_name = ORM::factory('qwt_wzbcfg')->where('bid', '=', $o->bid)->where('key', '=', 'name')->find()->value;
                  $suser=ORM::factory('qwt_login')->where('id','=',$o->bid)->find()->user;
                  $faid=ORM::factory('qwt_login')->where('id','=',$o->bid)->find()->faid;
                  $fadmin=ORM::factory('qwt_login')->where('id','=',$o->bid)->find()->fadmin;
                  $ssname=ORM::factory('qwt_wzbadmin')->where('id','=',$faid)->find()->name;
                  $aname=ORM::factory('qwt_wzbadmin')->where('id','=',$fadmin)->find()->name;
                  $typename='';
                  $beginname='';
                  if($faid==$fadmin){
                    $typename='直销';
