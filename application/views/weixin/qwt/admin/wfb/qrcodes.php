            ...
            <button class="am-btn  am-btn-default am-btn-success tpl-am-btn-success am-icon-search" type="submit"></button>
              ...
              <?php endif?>
                ...
                foreach ($result['qrcodes'] as $v):
                  ...
                  $count4 =ORM::factory('qwt_wfborder')->where('bid','=',$v->bid)->where('qid','=',$v->id)->and_where_open()->where('need_money','=',0)->or_where_open()->where('need_money','>',0)->and_where('order_state','=','1')->or_where_close()->and_where_close()->count_all();
                ?>
                ...
                <tr>
                  ...
                  <td id="score1<?=$v->id?>"><a href="/qwtwfba/orders?qid=<?=$v->id?>" title="查看兑换明细"><?=$count4?></a></td>
                  <td><?=$sex[$v->sex]?></td>
