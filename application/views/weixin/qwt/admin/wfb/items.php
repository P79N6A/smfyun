        ...
        <div class="tpl-content-wrapper">
            ...
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    ...
                    <div class="caption font-green bold">
                        ...
                        <a href="/qwtwfba/items/add" class="am-btn am-btn-default am-btn-success" style="margin-right:10px;margin-bottom:10px;height:40px"><span class="am-icon-plus"></span> 添加新奖品</a>
                        </div>
            ...
            <button class="am-btn  am-btn-default am-btn-success tpl-am-btn-success am-icon-search" type="submit"></button>
                ...
                <tr>
                  ...
                  <td nowrap="">
                  <a class="am-btn am-btn-default am-btn-xs am-text-secondary" href="/qwtwfba/items/edit/<?=$item->id?>" style="background-color:#fff;"><span class="am-icon-pencil-square-o"></span> 修改</a>
...
<?php endif?>
  ...
  swal({
    ...
    function(){
      window.location.href = "/qwtwfba/items?id="+id+"&DELETE=1";
    })
  })
    </script>
