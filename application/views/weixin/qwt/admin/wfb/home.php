    ...
    <div class="tpl-page-container tpl-page-header-fixed">
        <div class="tpl-content-wrapper">
          ...
          <?php endif?>
                ...
                if ($result['tpl']):
                  ?>
                  <a href="/qwtwfba/images/cfg/<?=$result['tpl']?>.v<?=time()?>.jpg" target="_blank">
                                            <div class="tpl-form-file-img">
                                                <img src="/qwtwfba/images/cfg/<?=$result['tpl']?>.v<?=time()?>.jpg" alt="" title="点击查看原图">
                                            </div>
                                            </a>
                                          <?php endif?>
                ...
                <div class="am-u-sm-6">
                                <div class="am-form-group">
                                    ...
                                    <label for="rank" class="am-form-label">积分名称自定义（为空则不修改，最长为两个字）</label>
                                        <input type="text" id="rank" name="text[scorename]"  maxlength='2' value="<?=$config['scorename']?>" placeholder="输入积分名称">
                                    </div>
                                </div>
                </div>
                <div class="am-u-sm-12">
                                ...
                                <div class="am-form-group">
                                    <label for="text_follow_url" class="am-u-sm-12 am-form-label">支付多少可以生成海报 单位：分（0表示不限,务必一键授权给有赞）</label>
                                    <div class="am-u-sm-12">
              <input type="number" class="tpl-form-input" id="rank" name="text[needpay]"  maxlength='4' value="<?=intval($config['needpay'])?>">
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <label for="text_follow_url" class="am-u-sm-12 am-form-label">用户未满足生成海报条件提示文案</label>
                                    <div class="am-u-sm-12">
              <textarea class="form-control" id="needtext" name="text[needtext]"><?=htmlspecialchars(str_replace("\n", '\n',$config['needtext']))?></textarea>
                                    </div>
                                </div>
            <div class="tpl-content-scope">
                <div class="note note-info">
              ...
              <input type="text" class="tpl-form-input" class="form-control" id="text_follow_url" name="text[text_follow_url]" placeholder="http://" value="<?=$config['text_follow_url']?>">
                    ...
                    <input type="text" class="tpl-form-input" id="goal3" name="text[text_goal3]"  value="<?=$config['text_goal3']?htmlspecialchars(str_replace("\n", '\n',$config['text_goal3'])):'恭喜您成为了「%s」的支持者~'?>">
                                ...
                                <div class="am-form-group">
                                    <label for="goal3" class="am-u-sm-12 am-form-label">重复扫描相同二维码回复文案</label>
                                    <div class="am-u-sm-12">
                    <input type="text" class="tpl-form-input" id="goal4" name="text[text_goal4]"  value="<?=$config['text_goal4']?htmlspecialchars(str_replace("\n", '\n',$config['text_goal4'])):'您已经是「%s」的支持者了，不用再扫了哦'?>">
                                    </div>
                                </div>
                                <div class="am-form-group">
...
<script type="text/javascript">
  swal({
    ...
    function(isConfirm){
      if (isConfirm) {
           window.location.href = "http://<?=$_SERVER['HTTP_HOST']?>/qwta/product/3";
      }
  })
</script>
