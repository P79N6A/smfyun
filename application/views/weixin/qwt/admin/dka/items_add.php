    ...
    <div class="tpl-page-container tpl-page-header-fixed">
        <div class="tpl-content-wrapper">
            ...
            <ol class="am-breadcrumb">
                <li><a href="#" class="am-icon-home">打卡宝</a></li>
                <li>奖品设置</li>
                <li>奖品管理</li>
  ...
  <input id="datetimepicker" size="16" type="text" name="data[endtime]" size="16" value="<?=$_POST['data']['endtime']?>" readonly="" class="am-form-field" readonly>
      ...
      <?php if($result['action']=='add'):?>
        ...
        <?php if ($result['action'] == 'edit' && $result['item']['pic']):?>
                                            ...
                                            <img class="img-thumbnail" src="/qwtdkaa/images/item/<?=$result['item']['id']?>.v<?=$result['item']['lastupdate']?>.jpg" width="100">
                                            </div>
                                          <?php endif?>
...
function change(i){
  ...
  swal({
    ...
    function(){
      window.location.href = "/qwtdkaa/items/edit/<?=$result['item']['id']?>?DELETE=1";
    })
  })
</script>
