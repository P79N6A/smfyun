...
?>
            ...
            <ol class="am-breadcrumb">
                ...
                <li><a href="/qwtfxba/stats_totle">数据统计</a></li>
            ...
            <div class="tpl-portlet-components">
              ...
              <li id="orders<?=$status?>" class="<?=$status== 1 ? 'am-active' : ''?>"><a href="/qwtfxba/stats_totle?qid=1">按天统计</a></li>
              <li id="orders<?=$status?>" class="<?=$status == 2? 'am-active' : ''?>"><a href="/qwtfxba/stats_totle/month?qid=2">按月统计</a></li>
              <li id="orders<?=$status?>" class="<?=$status == 3? 'am-active' : ''?>"><a href="/qwtfxba/stats_totle/shaixuan?qid=3">按日期筛选</a></li>
                            </ul>
