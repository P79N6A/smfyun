           ...
           <?php if ($result['s']):?>
            ...
            <button class="am-btn  am-btn-default am-btn-success tpl-am-btn-success am-icon-search" type="submit"></button>
                ...
                <div class="tpl-block">
                  ...
                  <tr>
                    <th>商品名</th>
                    <th nowrap=""><a href="/qwtfxba/stats_goods?sort=toprice" title="按交额">有赞成交金额</a></th>
                    <th nowrap=""><a href="/qwtfxba/stats_goods?sort=totle" title="按订单数">有赞订单数</th>
                    <th nowrap=""><a href="/qwtfxba/stats_goods?sort=tonum" title="按销售数量">销售数量</th>
