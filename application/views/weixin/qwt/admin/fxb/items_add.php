...
<?php if ($result['error']):?>
  ...
  <input id="datetimepicker" size="16" type="text" name="data[endtime]" size="16" value="<?=$_POST['data']['endtime']?>" readonly="" class="am-form-field" readonly>
      ...
      if (!$_POST['data']['url']) $type = 0;
      if ($_POST['data']['type']==3) $type = 3;
      if ($_POST['data']['type']==4) $type = 4;
      if ($_POST['data']['type']==5) $type = 6;
      if ($_POST['data']['type']==6) $type = 5;
      ?>
      ...
      <?php if($result['action']=='add'):?>
          ...
          <input type="number" class="form-control" id="pri" name="data[pri]" placeholder="展示优先级" value="<?=intval($_POST['data']['pri'])?>">
                                ...
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-12 am-form-label">产品名称 </label>
                                    <div class="am-u-sm-12">
        ...
        <?php if ($result['action'] == 'edit' && $result['item']['pic']):?>
                  <a href="/qwtfxba/images/item/<?=$result['item']['id']?>.v<?=$result['item']['lastupdate']?>.jpg" target="_blank">
                                            <div class="tpl-form-file-img">
                                            <img class="img-thumbnail" src="/qwtfxba/images/item/<?=$result['item']['id']?>.v<?=$result['item']['lastupdate']?>.jpg" width="100">
                                            </div>
                                            </a>
                                          <?php endif?>
...
4、请商户按照上述要求操作，因为运营操作不当、兑换门槛过低导致的损失，与我方无关；</p>
          ...
          <input type="number" class="form-control" id="stock" name="data[stock]" placeholder="输入库存数量" value="<?=intval($_POST['data']['stock'])?>">
                ...
                <div class="am-u-sm-4">
                                <div class="am-form-group">
                                    <div>
                                    <label for="user-weibo" class="am-form-label">产品价格</label>
          <input type="number" class="form-control" id="price" name="data[price]" placeholder="市场价" value="<?=floatval($_POST['data']['price'])?>">
                ...
                <div class="am-u-sm-4">
                                <div class="am-form-group">
                                    <div>
                                    <label for="user-weibo" class="am-form-label">消耗积分</label>
...
function change(i){
  ...
  swal({
    ...
    function(){
      window.location.href = "/qwtfxba/items/edit/<?=$result['item']['id']?>?DELETE=1";
    })
  })
</script>
