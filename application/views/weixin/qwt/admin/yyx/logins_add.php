...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="/qwtyyxa/items">账号管理</a></li>
  ...
  <form role="form" method="post" enctype="multipart/form-data">
    <div class="box-body">
      ...
      <div class="row">
        <div class="col-lg-5">
          <div class="form-group">
            <label for="name">清空海报生成时间（ticket）</label>
            <a href="/qwtyyxa/empty_ticket/<?=$bid?>"><button type="button" class="btn btn-warning">点击清空</button></a>
          </div>
        </div>
      </div>
      <?php endif?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="/qwtyyxa/items/edit/<?=$result['item']['id']?>?DELETE=1" class="btn btn-outline">确认删除</a>
      </div>
