...
?>
            ...
            <ol class="am-breadcrumb">
                ...
                <li><a href="/qwtxxba/stats_totle">数据统计</a></li>
            ...
            <select id="item" data-am-selected="{searchBox: 1}" name='iid'>
             <option value="all">全部</option>
              ...
              <li id="orders<?=$status?>" class="<?=$status== 1 ? 'am-active' : ''?>"><a href="http://<?=$_SERVER['HTTP_HOST'].'/qwtxxba/stats_totle'.'?'.$_SERVER['QUERY_STRING']?>&qid=1">按天统计</a></li>
              <li id="orders<?=$status?>" class="<?=$status == 2? 'am-active' : ''?>"><a href="http://<?=$_SERVER['HTTP_HOST'].'/qwtxxba/stats_totle/month'.'?'.$_SERVER['QUERY_STRING']?>&qid=2">按月统计</a></li>
              <li id="orders<?=$status?>" class="<?=$status == 3? 'am-active' : ''?>"><a href="http://<?=$_SERVER['HTTP_HOST'].'/qwtxxba/stats_totle/shaixuan'.'?'.$_SERVER['QUERY_STRING']?>&qid=3">按日期筛选</a></li>
                            </ul>
