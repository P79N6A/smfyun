...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="/qwtdlda/qrcodes">用户明细</a></li>
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                foreach ($result['qrcodes'] as $v):
                  $count2 = ORM::factory('qwt_dldqrcode')->where('bid', '=', $v->bid)->where('fopenid', '=', $v->openid)->count_all();
                ?>
                ...
                <tr>
                  ...
                  $url = '/qwtdld/index/'. $v->bid .'?url=home&cksum='. $cksum .'&openid='. base64_encode($v->openid);
                  $url2 = '/qwtdld/index/'. $v->bid .'?url=customer&cksum='. $cksum .'&openid='. base64_encode($v->openid);
                  ?>
                  </td>
...
$(document).on('change','#type',function(){
  ...
  window.location.href = 'http://<?=$_SERVER["HTTP_HOST"]?>/qwtdlda/qrcodes?type='+$('#type').val();
})
