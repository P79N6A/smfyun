                        ...
                        <div class="am-u-sm-12" style="padding:0">
                            ...
                            <div class="am-form-group">
                                <div class="am-u-sm-9 am-u-sm-push-3">
                                    <button type="submit" class="am-btn am-btn-success"><span class="am-icon-edit"></span><?=$result['title']?></button>
                                    <?php if ($result['action'] == 'edit'):?>
                                    <a class="am-btn am-btn-danger" id="delete">
                                        <span class="am-icon-remove"></span>删除该分组
                                    </a>
                                    <?php endif?>
                                </div>
                            </div>
...
<script>
  ...
  swal({
    ...
    function(){
      window.location.href = "/qwtdlda/group/edit/<?=$result['group']['id']?>?DELETE=1";
    })
  })
<?php if($result['error']):?>
