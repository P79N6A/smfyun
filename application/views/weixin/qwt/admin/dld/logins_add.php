...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="/qwtdlda/items">账号管理</a></li>
...
<!--       <div class="row">
        <div class="col-lg-5">
          <div class="form-group">
          <label for="saler_limit">销售员数量限制</label>
          <input type="number" maxlength="20" class="form-control" id="saler_limit" name="data[saler_limit]" placeholder="输入销售员数量" value="<?=intval($_POST['data']['saler_limit'])?>">
          <p class="help-block">最多生成海报且有订单的粉丝数，超出该限制后将不能生成海报。</p>
          </div>
        </div>
      </div> -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="/qwtdlda/items/edit/<?=$result['item']['id']?>?DELETE=1" class="btn btn-outline">确认删除</a>
      </div>
