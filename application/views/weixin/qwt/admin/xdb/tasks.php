服务号版
    <div class="tpl-page-container tpl-page-header-fixed">
        ...
        <div class="tpl-content-wrapper">
            ...
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    ...
                    <div class="caption font-green bold">
                        ...
                        <a href="/qwtxdba/tasks/add" class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"></span> 添加新任务</a>
                        </div>
            ...
            <button class="am-btn  am-btn-default am-btn-success tpl-am-btn-success am-icon-search" type="submit"></button>
                ...
                <tr>
                  <?php
                      $num=ORM::factory('qwt_xdbrecord')->where('bid','=',$bid)->where('tid','=',$task->id)->count_all();
                      $rank=ORM::factory('qwt_xdbsku')->where('bid','=',$bid)->where('tid','=',$task->id)->count_all();


                  ?>
                  <td><?=$task->name?></td>
                  <td><?=date('Y-m-d H:i',$task->endtime)?></td>
                  <td><a href="/qwtxdba/items_num/<?=$task->id?>"><span class="label label-warning">点击查看</span></a></td>
                  <td><?=$num?></td>
                  <td><?=$rank?></td>
                  <td>
                  <?php
                  ...
                  <td nowrap="">
                  <a style="background-color:#fff;" class='edit am-btn am-btn-default am-btn-xs am-text-secondary' href="/qwtxdba/tasks/edit/<?=$task->id?>"><span class="am-icon-pencil-square-o"></span> 修改</a>
  ...
  swal({
    ...
    function(){
      window.location.href = "/qwtxdba/tasks?tid="+id+"&DELETE=1";
    })
  })
    </script>
