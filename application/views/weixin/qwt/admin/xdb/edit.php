    ...
    <div class="col-xs-12">
            <form role="form" method="post" enctype="multipart/form-data">
                <div class="box-body textSet" style="background-color:white;">
                  ...
                  <span><?=convert3($item['key'])?>名称：</span><input type="text" class="form-control" id="" placeholder="" maxlength="50" name="edit[km_content]" placeholder="输入微信红包名称，如：‘恭喜发财’" value="<?=$item['km_content']?>" style="width:17%;"><br>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      ...
                      <a href="/xdba/items_delete/<?=$item['id']?>" class="btn btn-outline">确认删除</a>
                    </div>
