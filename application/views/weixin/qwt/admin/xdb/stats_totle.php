...
?>
            ...
            <ol class="am-breadcrumb">
                ...
                <li><a href="/qwtxdba/stats_totle">数据统计</a></li>
            ...
            <div class="tpl-portlet-components">
              ...
              <li id="orders<?=$status?>" class="<?=$status== 1 ? 'am-active' : ''?>"><a href="/qwtxdba/stats_totle?qid=1">按天统计</a></li>
              <li id="orders<?=$status?>" class="<?=$status == 2? 'am-active' : ''?>"><a href="/qwtxdba/stats_totle/month?qid=2">按月统计</a></li>
              <li id="orders<?=$status?>" class="<?=$status == 3? 'am-active' : ''?>"><a href="/qwtxdba/stats_totle/shaixuan?qid=3">按日期筛选</a></li>
                            </ul>
  ...
  <input name="data[over]" id="datetimepicker2" size="16" type="text" value="<?=$_GET['data']['over']?>" class="am-form-field" readonly>
            ...
            <button id="ssbtn" class="search-btn1 am-btn  am-btn-default am-btn-success am-icon-search" type="submit"></button>
                ...
                <div class="tpl-block">
                                ...
                                <table class="am-text-nowrap am-table am-table-striped am-table-hover table-main">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="table-title">新增订单数</th>
                                            <th class="table-type">奖品兑换数量</th>
                                            <th class="table-author am-hide-sm-only">下发兑换券数量</th>
                                            <th class="table-date am-hide-sm-only">新增订单金额</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                  ...
                  <tr>
                    <td><?=$newadd[$i]['time']?></td>
                    <td><?=$newadd[$i]['tradenum']?></td>
                    <td><?=$newadd[$i]['ordernum']?></td>
                    <td><?=$newadd[$i]['duihuansum']?></td>
                    <td><?=$newadd[$i]['moneysum']?></td>
                  </tr>
