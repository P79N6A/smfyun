...
<div class="tpl-page-container tpl-page-header-fixed">
    <div class="tpl-content-wrapper">
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <div class="actions" style="float:left">
                                    <input id="datatype" type="hidden" name="type" value="1">
                                    <ul class="actions-btn">
                                        <li id="switch-1" onclick="change(1)" data-type="1" class="switch-type green <?=$type==1||!$type ? 'green-on' : ''?>">实物奖品
                                        </li><!--
      ...
      <?php else:?>
                                ...
                                <?php endif?>
                        <div id="realgoods"  class="row typebox" <?=($type==1||!$type)?'':'style="display:none"'?>>
                            <div class="am-form-group">
        ...
        <?php if ($result['action'] == 'edit' && $item['pic']):?>
            <a href="/qwtyyhba/images/item/<?=$result['item']['id']?>.v<?=$item['lastupdate']?>.jpg" target="_blank">
                                            <div class="tpl-form-file-img">
                                            <img class="img-thumbnail" src="/qwtyyhba/images/item/<?=$result['item']['id']?>.v<?=$item['lastupdate']?>.jpg" width="100">
                                            </div>
                                            </a>
                                          <?php endif?>
...
<div id="file-pic" style="display:inline-block;"></div>
          ...
          <input type="hidden" name="MAX_FILE_SIZE" value="307200" />
                            ...
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-form-label">所需付款金额（单位：分，为0则不设置；请按照教程完成相关设置。）
                                </label>
                                <div class="am-u-sm-9">
                        ...
                        <div class="row typebox" id="yzcoupons" <?=($type==5)?'':'style="display:none"'?>>
                            ...
                            <div class="am-form-group" >
                                <label for="user-phone" class="am-u-sm-3 am-form-label">有赞有赞优惠券</label>
                                <div class="am-u-sm-9">
                        ...
                        <div class="am-u-sm-12" style="padding:0">
                            ...
                            <div class="am-form-group">
                                <div class="am-u-sm-9 am-u-sm-push-3">
                                    ...
                                    <a class="am-btn am-btn-danger" id="delete" data-toggle="modal" data-target="#deleteModel">
...
function change(i){
  ...
  swal({
    ...
    function(){
      window.location.href = "/qwtyyhba/items_delete/<?=$result['item']['id']?>";
    })
  })
 $(function() {
