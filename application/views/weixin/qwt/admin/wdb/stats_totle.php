...
?>
            ...
            <ol class="am-breadcrumb">
                ...
                <li><a href="/qwtwdba/stats_totle">数据统计</a></li>
            ...
            <div class="tpl-portlet-components">
              ...
              <li id="orders<?=$status?>" class="<?=$status== 1 ? 'am-active' : ''?>"><a href="/qwtwdba/stats_totle?qid=1">按天统计</a></li>
              <li id="orders<?=$status?>" class="<?=$status == 2? 'am-active' : ''?>"><a href="/qwtwdba/stats_totle/month?qid=2">按月统计</a></li>
              <li id="orders<?=$status?>" class="<?=$status == 3? 'am-active' : ''?>"><a href="/qwtwdba/stats_totle/shaixuan?qid=3">按日期筛选</a></li>
                            </ul>
  ...
  <span>-</span>
  <input name="data[over]" id="datetimepicker2" size="16" type="text" value="<?=$_POST['data']['over']?>" class="am-form-field" readonly>
                                ...
                                <table class="am-text-nowrap am-table am-table-striped am-table-hover table-main">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="table-title">新增粉丝数量</th>
                                            <th class="table-type">生成海报数量</th>
                                            <th class="table-author am-hide-sm-only">活动参与人数</th>
                                            <th class="table-date am-hide-sm-only">奖品兑换数量</th>
                                        </tr>
                                    </thead>
                                    <tbody>
