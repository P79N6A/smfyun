...
<div class="second-menu">
        <div class="tpl-left-nav tpl-left-nav-hover">
            ...
            <div class="tpl-left-nav-list">
                <ul class="tpl-left-nav-menu">
                    <li class="tpl-left-nav-item">
                        <a href="https://h5.youzan.com/v2/feature/kS7Xerjoap" target="_blank" class="nav-link">
                            <i class="am-icon-book"></i>
                            <span>使用教程</span>
                        </a>
                    </li>
                    <li class="tpl-left-nav-item">
                        <a href="/qwtdkaa/home" class="nav-link <?=isActive('home')?>">
                    ...
                    <li class="tpl-left-nav-item">
                        ...
                        <ul class="tpl-left-nav-sub-menu">
                            <li>
                                <a href="/qwtdkaa/items" class="<?=isActive('items')?>">
                                    <i class="am-icon-angle-right"></i>
                                    <span>奖品管理</span>
                                </a>
                            </li>
                            <li>
                                <a href="/qwtdkaa/orders" class="<?=isActive('orders')?>">
                                    <i class="am-icon-angle-right"></i>
                                    <span>兑换记录</span>
                                </a>
                            </li>
                    ...
                    <li class="tpl-left-nav-item">
                        <a href="javascript:;" class="nav-link tpl-left-nav-link-list <?=isOpened(array('zero', 'lab'))?>">
                        ...
                        <ul class="tpl-left-nav-sub-menu">
                            <li>
                                <a href="/qwtdkaa/zero" class="<?=isActive('zero')?>">
                                    <i class="am-icon-angle-right"></i>
                                    <span>积分清零</span>
                                </a>
                            </li>
                            <li>
                                <a href="/qwtdkaa/lab" class="<?=isActive('lab')?>">
                                    <i class="am-icon-angle-right"></i>
                                    <span>批量打标签</span>
                                </a>
                            </li>
                    ...
                    <li class="tpl-left-nav-item">
                        <a href="/qwtdkaa/qrcodes" class="nav-link <?=isActive('qrcodes')?>">
                            <i class="am-icon-users"></i>
                            <span>用户明细</span>
                        </a>
                    </li>
                    <li class="tpl-left-nav-item">
                        <a href="/qwtdkaa/stats_totle" class="nav-link <?=isActive('stats_totle')?>">
            ...
            <?php if($_SESSION['dkaa']['admin'] >= 1):?>
                    <li class="tpl-left-nav-item">
                                <a href="/qwtdkaa/hb_check" class="nav-link <?=isActive('hb_check')?>">
