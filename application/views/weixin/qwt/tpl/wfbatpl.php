            ...
            <div class="tpl-left-nav-list">
                <ul class="tpl-left-nav-menu">
                    <li class="tpl-left-nav-item">
                        <a href="https://h5.youzan.com/v2/feature/8M6ab8DI4c" target="_blank" class="nav-link">
                            <i class="am-icon-book"></i>
                            <span>使用教程</span>
                        </a>
                    </li>
                    <li class="tpl-left-nav-item">
                        <a href="/qwtwfba/home" class="nav-link <?=isActive('home')?>">
                    ...
                    <li class="tpl-left-nav-item">
                        ...
                        <ul class="tpl-left-nav-sub-menu">
                            <li>
                                <a href="/qwtwfba/items" class="<?=isActive('items')?>">
                                    <i class="am-icon-angle-right"></i>
                                    <span>奖品管理</span>
                                </a>
                            </li>
                            <li>
                                <a href="/qwtwfba/orders" class="<?=isActive('orders')?>">
                                    <i class="am-icon-angle-right"></i>
                                    <span>兑换记录</span>
                                </a>
                            </li>
                    ...
                    <li class="tpl-left-nav-item">
                        <a href="javascript:;" class="nav-link tpl-left-nav-link-list <?=isOpened(array('zero', 'area','cancle','rsync','hb_check'))?>">
                        ...
                        <ul class="tpl-left-nav-sub-menu">
                            <li>
                                <a href="/qwtwfba/zero" class="<?=isActive('zero')?>">
                                    <i class="am-icon-angle-right"></i>
                                    <span>积分清零</span>
                                </a>
                            </li>
                            <li>
                                <a href="/qwtwfba/area" class="<?=isActive('area')?>">
                                    <i class="am-icon-angle-right"></i>
                                    <span>可选地区</span>
                                </a>
                            </li>
                            <li>
                                <a href="/qwtwfba/cancle" class="<?=isActive('cancle')?>">
                                    <i class="am-icon-angle-right"></i>
                                    <span>取消关注扣除积分</span>
                                </a>
                            </li>
                            <li>
                                <a href="/qwtwfba/rsync" class="<?=isActive('rsync')?>">
                                    <i class="am-icon-angle-right"></i>
                                    <span>有赞积分同步</span>
                                </a>
                            </li>
                            <li>
                                <a href="/qwtwfba/hb_check" class="<?=isActive('hb_check')?>">
                                    <i class="am-icon-angle-right"></i>
                                    <span>红包发送审核</span>
                                </a>
                            </li>
                    ...
                    <li class="tpl-left-nav-item">
                        <a href="/qwtwfba/qrcodes" class="nav-link <?=isActive('qrcodes')?>">
                            <i class="am-icon-users"></i>
                            <span>用户明细</span>
                        </a>
                    </li>
                    <li class="tpl-left-nav-item">
                        <a href="/qwtwfba/stats_totle" class="nav-link <?=isActive('stats_totle')?>">
