        ...
        <div class="tpl-left-nav tpl-left-nav-hover">
            ...
            <div class="tpl-left-nav-list">
                <ul class="tpl-left-nav-menu">
                    ...
                    <li class="tpl-left-nav-item">
                        <a href="/qwtrwda/home" class="nav-link <?=isActive('home')?>">
                    ...
                    <li class="tpl-left-nav-item">
                        ...
                        <ul class="tpl-left-nav-sub-menu">
                            <li>
                                <a href="/qwtrwda/items" class="<?=isActive('items')?>">
                                    <span>奖品管理</span>
                                </a>
                            </li>
                            <li>
                                <a href="/qwtrwda/tasks" class="<?=isActive('tasks')?>">
                                    <span>任务管理</span>
                                </a>
                            </li>
                            <li>
                                <a href="/qwtrwda/orders" class="<?=isActive('orders')?>">
                                    <span>领取记录</span>
                                </a>
                            </li>
                        </ul>
                    ...
                    <li class="tpl-left-nav-item">
                        ...
                        <ul class="tpl-left-nav-sub-menu">
                            <li>
                                <a href="/qwtrwda/area" class="<?=isActive('area')?>">
                                    <span>可选地区</span>
                                </a>
                            </li>
                            <!-- <li>
                                <a href="/qwtrwda/lab" class="<?=isActive('lab')?>">
                                    <span>批量打标签</span>
                                </a>
                            </li> -->
                        </ul>
                    ...
                    <li class="tpl-left-nav-item">
                        <a href="/qwtrwda/qrcodes" class="nav-link <?=isActive('qrcodes')?>">
                            <i class="am-icon-users"></i>
                            <span>用户明细</span>
                        </a>
                    </li>
                    <li class="tpl-left-nav-item">
                        <a href="/qwtrwda/stats_totle" class="nav-link <?=isActive('stats_totle')?>">
