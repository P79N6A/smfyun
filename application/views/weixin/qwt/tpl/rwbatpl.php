            ...
            <div class="tpl-left-nav-list">
                <ul class="tpl-left-nav-menu">
                    <li class="tpl-left-nav-item">
                        <a href="https://h5.youzan.com/v2/feature/caxl4yyyjz" target="_blank" class="nav-link">
                            <i class="am-icon-book"></i>
                            <span>使用教程</span>
                        </a>
                    </li>
                    <li class="tpl-left-nav-item">
                        <a href="/qwtrwba/home" class="nav-link <?=isActive('home')?>">
                            <i class="am-icon-cog"></i>
                            <span>个性化设置</span>
                        </a>
                    </li>
                    <li class="tpl-left-nav-item">
                        <a href="javascript:;" class="nav-link tpl-left-nav-link-list <?=isOpened(array('items', 'tasks','orders'))?>">
                        ...
                        <ul class="tpl-left-nav-sub-menu">
                            <li>
                                <a href="/qwtrwba/items" class="<?=isActive('items')?>">
                                    <span>奖品管理</span>
                                </a>
                            </li>
                            <li>
                                <a href="/qwtrwba/tasks" class="<?=isActive('tasks')?>">
                                    <span>任务管理</span>
                                </a>
                            </li>
                            <li>
                                <a href="/qwtrwba/orders" class="<?=isActive('orders')?>">
                                    <span>领取记录</span>
                                </a>
                            </li>
                        </ul>
                    ...
                    <li class="tpl-left-nav-item">
                        ...
                        <ul class="tpl-left-nav-sub-menu">
                            <li>
                                <a href="/qwtrwba/area" class="<?=isActive('area')?>">
                                    <span>可选地区</span>
                                </a>
                            </li>
                            <li>
                                <a href="/qwtrwba/lab" class="<?=isActive('lab')?>">
                                    <span>批量打标签</span>
                                </a>
                            </li>
                        </ul>
                    ...
                    <li class="tpl-left-nav-item">
                        <a href="/qwtrwba/qrcodes" class="nav-link <?=isActive('qrcodes')?>">
                            <i class="am-icon-users"></i>
                            <span>用户明细</span>
                        </a>
                    </li>
                    <li class="tpl-left-nav-item">
                        <a href="/qwtrwba/stats_totle" class="nav-link <?=isActive('stats_totle')?>">
