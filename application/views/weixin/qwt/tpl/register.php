...
<div class="container">
    ...
    <form class="form-signin" method="post">
        ...
        <div class="login-wrap">
            <p style="text-align:center">注册个人信息</p>
            ...
            <span style='color:red'>*</span>
            <input style="display: inline-block;width: 95%;" name='pass' type="text" autofocus="" placeholder="密码" class="form-control">
            <span style='color:red'>&nbsp;&nbsp;</span>
    ...
    $('.click_change').click(function(event) {
        if(a<0||a==0){
            $.ajax({
                ...
                url: "/qwta/register?createcode=1&tel="+$('#tel').val(), // 加随机数防止缓存
                type: "get",
                dataType: "json",
