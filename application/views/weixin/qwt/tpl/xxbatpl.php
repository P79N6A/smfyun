            ...
            <div class="tpl-left-nav-list">
                <ul class="tpl-left-nav-menu">
                    <li class="tpl-left-nav-item">
                        <a href="https://h5.youzan.com/v2/feature/DPmwkgetD8" target="_blank" class="nav-link">
                            <i class="am-icon-book"></i>
                            <span>使用教程</span>
                        </a>
                    </li>
                    <li class="tpl-left-nav-item">
                        <a href="/qwtxxba/home" class="nav-link <?=isActive('home')?>">
                            <i class="am-icon-cog"></i>
                            <span>基础设置</span>
                        </a>
                    </li>
                    <li class="tpl-left-nav-item">
                        <a href="/qwtxxba/msgs" class="nav-link <?=isActive(array('msgs','msgs_add'))?>">
                            <i class="am-icon-envelope"></i>
                            <span>发送内容管理</span>
                        </a>
                    </li>
                    <li class="tpl-left-nav-item">
                        <a href="/qwtxxba/rules" class="nav-link <?=isActive(array('rules','rules_add'))?>">
                            <i class="am-icon-list-ol"></i>
                            <span>发送规则</span>
                        </a>
                    </li>
                    <li class="tpl-left-nav-item">
                        <a href="/qwtxxba/stats_totle?qid=1" class="nav-link <?=isActive(array('stats_totle'))?>">
                            <i class="am-icon-list-ol"></i>
                            <span>数据统计</span>
                        </a>
                    </li>
