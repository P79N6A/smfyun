...
<div class="second-menu">
        <div class="tpl-left-nav tpl-left-nav-hover">
            <div class="tpl-left-nav-title" style="height:80px">
                公众号自动下发小程序卡片工具
            </div>
            <div class="tpl-left-nav-list">
                <ul class="tpl-left-nav-menu">
                    <li class="tpl-left-nav-item">
                        <a href="https://h5.youzan.com/v2/feature/vsyZVhEXB2" target="_blank" class="nav-link">
                            <i class="am-icon-book"></i>
                            <span>使用教程</span>
                        </a>
                    </li>
                    <li class="tpl-left-nav-item">
                        <a href="/qwtzdfa/msgs" class="nav-link <?=isActive('msgs')?>">
                            <i class="am-icon-th-large"></i>
                            <span>小程序卡片管理</span>
                        </a>
                    </li>
                    <li class="tpl-left-nav-item">
                        <a href="javascript:;" class="nav-link tpl-left-nav-link-list <?=isOpened(array('rules','rules_add','follow','payed'))?>">
                        ...
                        <ul class="tpl-left-nav-sub-menu">
                            <li>
                                <a href="/qwtzdfa/follow" class="<?=isActive('follow')?>">
                                    <span>关注公众号后下发</span>
                                </a>
                            </li>
                            <li>
                                <a href="/qwtzdfa/rules" class="<?=isActive('rules')?>">
                                    <span>输入关键词后下发</span>
                                </a>
                            </li>
                            <li>
                                <a href="/qwtzdfa/payed" class="<?=isActive('payed')?>">
                                    <span>有赞微商城下单后下发</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    <!-- <li class="tpl-left-nav-item">
                        <a href="/qwtzdfa/stats_totle?qid=1" class="nav-link <?=isActive(array('stats_totle'))?>">
                            <i class="am-icon-list-ol"></i>
                            <span>数据统计</span>
                        </a>
                    </li> -->
