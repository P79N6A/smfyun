...
<html>
  <head>
    ...
    <title><?=$title?> | <?=$config['name']?> | 微商代理</title>
  ...
  <body class="hold-transition skin-red sidebar-mini">
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <!-- Logo -->
        <a href="/wsda/home" class="logo">
          <span class="logo-mini"><b>代</b></span>
          <span class="logo-lg"><i class="fa fa-wechat"></i>&nbsp;<b>微商代理</b></span>
        </a>
        ...
        <nav class="navbar navbar-static-top" role="navigation">
          ...
          <? else:?>
          <span style='display:inline-block;padding-top:15px;color:#f6f6f6;'><a href="https://h5.youzan.com/v2/feature/b3vwj9n2" style="color:white;" target="_blank">点击这里查看微商代理系统使用说明书</a></span>
          <? endif;?>
          <!-- Navbar Right Menu -->
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <!-- Menu Toggle Button -->
                <a href="/wsda/logout" class="dropdown-toggle">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li class=""><a target="_blank" href="https://h5.youzan.com/v2/feature/b3vwj9n2"><i class="fa fa-circle-o"></i> <span>使用说明书</span> </a></li>              </ul>
            </li>
            <li class="<?=isActive('home')?>"><a href="/wsda/home"><i class="fa fa-dashboard"></i> <span>基础设置</span></a></li>
...
<!--             <li class="treeview <?=isActive(array('items', 'shorders'))?>">
            ...
            <li class="treeview <?=isActive(array('qrcodes_m','skus','group','group_add'))?>">
              ...
              <ul class="treeview-menu">
                <li class="<?=isActive('group')?>"><a href="/wsda/group"><i class="fa fa-circle-o"></i> <span>代理分组设置</span> </a></li>
                <li class="<?=isActive('skus')?>"><a href="/wsda/skus"><i class="fa fa-circle-o"></i> <span>代理设置</span> </a></li>
                <li class="<?=isActive('qrcodes_m')?>"><a href="/wsda/qrcodes_m"><i class="fa fa-circle-o"></i> <span>代理列表</span> </a></li>
                <li><a href="/wsd/order_top/<?=$_SESSION['wsda']['bid']?>" target="_blank"><i class="fa fa-circle-o"></i> <span>销量排行</span> </a></li>
              </ul>
            </li>
            <li class="<?=isActive('setgood1s')?>"><a href="/wsda/setgood1s"><i class="fa fa-shopping-cart"></i> <span>商品管理</span></a></li>
            <li class="<?=isActive('customers')?>"><a href="/wsda/customers"><i class="fa fa-user-secret"></i> <span>客户管理</span></a></li>
            <li class="<?=isActive('history_trades')?>"><a href="/wsda/history_trades"><i class="fa fa-list"></i> <span>订单管理</span> </a></li>
           <li class="treeview <?=isActive(array('calculate','history_scores','profit'))?>">
            ...
            <ul class="treeview-menu">
              <li class="<?=isActive('calculate')?>"><a href="/wsda/calculate"><i class="fa fa-circle-o"></i> <span>个人团队奖励结算账单</span> </a></li>
              <li class="<?=isActive('profit')?>"><a href="/wsda/profit"><i class="fa fa-circle-o"></i> <span>销售利润结算账单</span></a></li>
              <li class="<?=isActive('history_scores')?>"><a href="/wsda/history_scores"><i class="fa fa-circle-o"></i> <span>账单结算记录</span> </a></li>
            </ul>
          </li>
          <li class="treeview <?=isActive(array('stats_totle','stats_goods'))?>">
            <a href="#"><i class="fa fa-calculator"></i> <span>数据统计</span> <i class="fa fa-angle-left pull-right"></i></a>
            <ul class="treeview-menu">
              <li class="<?=isActive('stats_totle')?>"><a href="/wsda/stats_totle"><i class="fa fa-circle-o"></i> <span>概况</span> </a></li>
              <li class="<?=isActive('stats_goods')?>"><a href="/wsda/stats_goods"><i class="fa fa-circle-o"></i> <span>商品统计</span></a></li>
            </ul>
          </li>
            <?php if($_SESSION['wsda']['admin'] >= 1):?>
              <li class="<?=isActive('admin')?>"><a href="/wsda/logins"><i class="fa fa-credit-card"></i> <span>账号管理</span></a></li>
            <?php endif?>
