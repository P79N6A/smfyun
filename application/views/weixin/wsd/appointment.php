...
$news = array(
    "fTitle" =>$result['title'],
    // "fDescription"=>"快来加入我的团队成为".$shop->shopname."的代理商吧！",
    "fDescription"=>"亲爱的，快来加入我的团队，和我一起赚钱吧~",
    "fPicUrl" =>$fuser->headimgurl,//logo
    "Url" => 'http://'.$_SERVER["HTTP_HOST"].'/wsd/appointment/'.$fuser->openid.'/'.$bid,
    // "Title"=>"快来加入我的团队成为".$shop->shopname."的代理商吧！",
    "Title"=>"亲爱的，快来加入我的团队，和我一起赚钱吧~",
