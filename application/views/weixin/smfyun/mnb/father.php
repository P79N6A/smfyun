      ...
      <?php endif?>
			...
			<form method="post">
				<div class="login-ic" style="background:rgba(0,0,0,.32);">
					<i class="icon4"></i>
					<input class="forleftline" type="text" name="wx_username" placeholder="微信号">
					<div class="clear"> </div>
				</div>
				<div class="login-ic" style="background:rgba(0,0,0,.32);">
					<i></i>
					<input class="forleftline" type="text" name="fname" placeholder="上级姓名">
					<div class="clear"> </div>
				</div>
				<div class="login-ic" style="background:rgba(0,0,0,.32);">
					<i class="icon3"></i>
					<input class="forleftline" type="text" name="fpcode" placeholder="上级授权码">
					<div class="clear"> </div>
				</div>

				<div class="log-bwn">
					<button type="submit" class="loginbutton" style="background-color:#b6ff56;border-color:#b6ff56">提交</button>
				</div>
				</form>
			</div>
