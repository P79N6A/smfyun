        ...
        <li>
            <div class="cd-single-item">
                <ul class="cd-slider-wrapper">
                    <li class="selected"><img src="<?=$config['cdn']?>/qwtwfb/images/item/<?=$order->item->id?>.v<?=$order->item->lastupdate?>.jpg" alt="<?=$order->item->name?>"></li>
                </ul>
            </div> <!-- .cd-single-item -->
                ...
                <div class="order-info">
                    ...
                    <li class="right"><b>消费<?=$config['score2']?>：</b><?=$order->score?><?=$config['score2']?><?=$order->need_money>0?'+'.($order->need_money/100).'元':''?></li>
