...
$failscore=ORM::factory('qwt_wfbfailscore')->where('bid','=',$score->bid)->where('qid','=',$score->qid)->where('sid','=',$score->id)->find();
$id--;
?>
            <div class="event">
                <div class="typeandtime">
                    <div class="type"><?=str_replace("积分", $scorename, $score->getTypeName($score->type));?></div>
            ...
            <?php if($failscore->id):?>
                <div class="event">
                <div class="typeandtime">
                    <div class="type"><?='积分同步失败:'.$failscore->log?></div>
                    <div class="time"><?=date('Y-m-d', $failscore->lastupdate)?></div>
                </div>
                <div class="<?=$score->score > 0 ? 'score score1' : 'score score0'?>">
                    <?=$score->score?>
                </div>
