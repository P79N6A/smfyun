<?php
//获取推荐用户
if ($user2['fopenid']) $fuser[] = ORM::factory('qwt_dkaqrcode')->where('openid', '=', $user2['fopenid'])->find()->nickname . ' 推荐';
//是否火种用户
...
?>
    ...
    <div class="block" >
        ...
        <a style="cursor: default;" href="/qwtdka/ddtop">
    ...
    <div class="block block-list block-list-actions" style="margin: 20px 0 -1px 0;">
        <a class="block-item clearfix arrow" href="/qwtdka/ddscore"><p class="c-black font-size-14">收支明细</p></a>
        <a class="block-item clearfix arrow" href="/qwtdka/ddtop"><p class="c-black font-size-14">业绩排行</p></a>
    ...
    <div class="action-container" style="margin:20px 0"><a href="/qwtdka/money" class="js-spread btn btn-block btn-green">我要提现</a></div>
