...
<head>
	...
	<style>
		*{
		...
		.imgbg{
			background: url(/qwtdka/images/cfg/<?=$result['qwtdka']?>.v<?=time()?>.jpg) no-repeat;
		...
		.shake_box {
            ...
            .shakTop span,.shakBottom span{
                background: url(http://<?=$_SERVER['HTTP_HOST']?>/qwt/dka/dist/img/shakBox.png) no-repeat;
                position : absolute;
                left: 50%;
                width :225px;
                height: 127px;
...
<body>
	...
	<div class="headbox">
		...
		<div class="box2" onclick="init()">
			<img class="img2" src="http://<?=$_SERVER['HTTP_HOST']?>/qwt/dka/dist/img/yyy.png">
		</div>
		<?endif?>
	</div>
	...
	<div class="canjia">
		...
		<div class="yaoqing">
			<img src="http://<?=$_SERVER['HTTP_HOST']?>/qwt/dka/dist/img/yq.png">
...
<!-- 	<div class="box11">
		...
		<a href="/qwtdka/home"><div class="tixian">立即提现</div></a>
	</div> -->
	<div class="fenge"></div>
	...
	<div class="box22">
		...
		<a href="/qwtdka/items">
			<div class="jifen">
				<img class="img3" src="http://<?=$_SERVER['HTTP_HOST']?>/qwt/dka/dist/img/jfsc.png">
                ...
                if ((curTime - lastUpdate)> 100) {
                  ...
                  success: function (res){
                        $("body").append(
                         ...
                         "<div class=\"mtk\">"+
							"<div class=\"mtkcont\">"+
								"<img class=\"mtkpic\" src=\"http://<?=$_SERVER['HTTP_HOST']?>/qwt/dka/dist/img/right.png\">"+
...
<script language="javascript">
    window.flag=1;
        ...
        $('.yaoqing').click(function() {
            $.ajax({
              url: '../smfyun/qwt_dka/<?=$bid?>?poster=1&openid=<?=$openid?>',
              type: 'post',
              dataType: 'text',
              timeout:15000,
			  beforeSend:function(XMLHttpRequest){
	            $("body").append(
                    "<div class=\"mtk\">"+
						"<img class=\"imgload\" src=\"http://<?=$_SERVER['HTTP_HOST']?>/qwt/dka/dist/img/loading.gif\">"+
        ...
        $(document).on('click', '.exit',function(){
            $("body").append(
            	"<div class=\"message_box mask\">"+
								"<div class=\"imgbg00\">"+
									"<img src=\"http://<?=$_SERVER['HTTP_HOST']?>/qwt/dka/dist/img/exit1.png\">"+
									"<div class=\"btn00\">"+
									"<form method=\"post\">"+
            ...
            if(eggflag==1&&eggst==1){
                $("body").append(
                	"<div class=\"message_box\" >" +
                   		 "<img class=\"egg1\" src=\'http://<?=$_SERVER['HTTP_HOST']?>/qwt/dka/dist/img/egg_1.png\' style=\'width:50%;height:auto;left:25%;top:20%;position:absolute;\' id=\'zjd\'/>"+
                    "</div>"
				);
                $(document).on('click', '#zjd', function() {
                    //请求后台数据
                    $('#zjd').attr('src','http://<?=$_SERVER['HTTP_HOST']?>/qwt/dka/dist/img/egg_2.png');
                    // $(".message_box").remove();
                  window.setTimeout(function () {
                     $.ajax({
                      url: '/qwtdka/dka?egg=true',
                      type: 'get',
                      dataType: 'json',
                      timeout:15000,
	                  success: function (res){
