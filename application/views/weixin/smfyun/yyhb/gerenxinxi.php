...
<body>
	<div class="aui-container">
		<div class="aui-page">
            ...
            <input id="name"  type="hidden" name="data[name]" value="1">
            <input id="tel" type="hidden" name="data[tel]" value="1">
            <input id="prov" class='prov' type="hidden" name="s_province" value="1">
            <input id="city" class='city' type="hidden" name="s_city" value="1">
            <input id="dist" class='dist' type="hidden" name="s_dist" value="1">
            <input id="address"  type="hidden" name="data[address]" value="1">
						<!-- <li class="b-line">
