<?php
// print_r($order);
$score = ORM::factory('qwt_qfxscore')->where('qid', '=', $user2['id'])->where('tid', '=', $order->id)->find();
...
<ul class="block block-list c-gray-dark">
    ...
    <li class="block-item">佣金<span class="pull-right font-size-18 c-green">￥<?=$score->score?></span></li>
    <li class="block-item">
        ...
        <p class="line-height-30 font-size-14">佣金比例<span class="pull-right"><?=ceil(($score->score/$order->money)*100)?>%</span></p>
