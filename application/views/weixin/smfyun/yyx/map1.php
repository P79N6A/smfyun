      ...
      <script type="text/javascript">
       ...
       <script type="text/javascript">
        ...
        setInterval(function(){
            $.ajax({
                url: 'http://<?=$_SERVER["HTTP_HOST"]?>/qwtdpm/smfyun?t=1',
                type: 'GET',
                dataType: 'json',
       ...
       <script type="text/javascript">
        setInterval(function(){
            $.ajax({
                url: 'http://<?=$_SERVER["HTTP_HOST"]?>/qwtdpm/smfyun?t=2',
                type: 'GET',
                dataType: 'json',
                success:function(res) {
       ...
       <script type="text/javascript">
        setInterval(function(){
            $.ajax({
                url: 'http://<?=$_SERVER["HTTP_HOST"]?>/qwtdpm/smfyun?t=3',
                type: 'GET',
                dataType: 'json',
                success:function(res) {
       ...
       <script type="text/javascript">
        ...
        setInterval(function(){
            $.ajax({
                url: 'http://<?=$_SERVER["HTTP_HOST"]?>/qwtdpm/smfyun?t=4',
                type: 'GET',
                dataType: 'json',
                success:function(res) {
                    var str = '';
       ...
       <script type="text/javascript">//热销商品
        $.ajax({
            url: 'http://<?=$_SERVER["HTTP_HOST"]?>/qwtdpm/smfyun?t=5',
            type: 'GET',
            dataType: 'json',
            success:function(res) {
                window.res5 = res;
       ...
       <script type="text/javascript">//热销商品
        $.ajax({
            url: 'http://<?=$_SERVER["HTTP_HOST"]?>/qwtdpm/smfyun?t=6',
            type: 'GET',
            dataType: 'json',
            success:function(res) {
                window.res6 = res;
       ...
       <script type="text/javascript">
          $(document).on('click', '.ri', function() {
                $.ajax({
                url: 'http://<?=$_SERVER["HTTP_HOST"]?>/qwtdpm/smfyun?t=d',
                type: 'GET',
                dataType: 'json',
                success:function(res) {
                  window.trade_data_val = [];
          ...
          $(document).on('click', '.yue', function() {
                $.ajax({
                url: 'http://<?=$_SERVER["HTTP_HOST"]?>/qwtdpm/smfyun?t=m',
                type: 'GET',
                dataType: 'json',
                success:function(res) {
                  window.trade_data_val = [];
          ...
          $(document).on('click', '.nian', function() {
                $.ajax({
                url: 'http://<?=$_SERVER["HTTP_HOST"]?>/qwtdpm/smfyun?t=y',
                type: 'GET',
                dataType: 'json',
                success:function(res) {
                  window.trade_data_val = [];
       ...
       <script type="text/javascript">
          $(document).on('click', '.ri2', function() {
                $.ajax({
                url: 'http://<?=$_SERVER["HTTP_HOST"]?>/qwtdpm/smfyun?t=d2',
                type: 'GET',
                dataType: 'json',
                success:function(res) {
                  window.area_dataAxis = [];
          ...
          $(document).on('click', '.yue2', function() {
                $.ajax({
                url: 'http://<?=$_SERVER["HTTP_HOST"]?>/qwtdpm/smfyun?t=m2',
                type: 'GET',
                dataType: 'json',
                success:function(res) {
                  window.area_dataAxis = [];
          ...
          $(document).on('click', '.nian2', function() {
                $.ajax({
                url: 'http://<?=$_SERVER["HTTP_HOST"]?>/qwtdpm/smfyun?t=y2',
                type: 'GET',
                dataType: 'json',
                success:function(res) {
                  window.area_dataAxis = [];
