...
<head>
	...
	<title>实物奖品领取</title>
	<link rel="stylesheet" type="text/css" href="http://<?=$_SERVER['HTTP_HOST']?>/sqb/css/ui.css">
	<link href="http://<?=$_SERVER['HTTP_HOST']?>/sqb/favicon.ico" type="image/x-icon" rel="icon">
	<link href="http://<?=$_SERVER['HTTP_HOST']?>/sqb/iTunesArtwork@2x.png" sizes="114x114" rel="apple-touch-icon-precomposed">
    <link href="http://<?=$_SERVER['HTTP_HOST']?>/sqb/css/layout.min.css" rel="stylesheet" />
    <link href="http://<?=$_SERVER['HTTP_HOST']?>/sqb/css/scs.min.css" rel="stylesheet" />
	<style type="text/css">
	.avator{
		height: 30px;
		position: absolute;
...
<body>
	<div class="aui-container">
            ...
            <input id="address"  type="hidden" name="data[address]">
						<!-- <li class="b-line">
							<a class="link-input" data-name="name">
								...
								<input id="input-name" name="text[name]" type="hidden" value="请输入收货人姓名">
						...
						<li class="b-line">
							<a class="link-input" data-name="tel">
								<h3>电话</h3>
								<span id="text-tel"></span>
								<input id="input-tel" name="text[tel]" type="hidden" value="请输入联系电话">
								<div class="aui-time"><i class="aui-jump"></i></div>
							</a>
						</li>
						<li class="b-line">
        ...
        <input type="text" readonly id="myAddrs" name="text[area]" data-key="4-84-1298" value="点击此处选择" />
						</li>
                        <li class="b-line">
                            <a class="link-input" data-name="addr">
                                <h3>详细地址</h3>
                                <span id="text-addr"></span>
                                <input id="input-addr" name="text[addr]" type="hidden" value="请输入详细地址">
                                <div class="aui-time"><i class="aui-jump"></i></div>
                            </a>
                        </li> -->
					</ul>
    ...
    <script src="http://<?=$_SERVER['HTTP_HOST']?>/sqb/js/jquery.min.js"></script>
    <script src="http://<?=$_SERVER['HTTP_HOST']?>/sqb/js/jquery.scs.min.js"></script>
    <script src="http://<?=$_SERVER['HTTP_HOST']?>/sqb/js/CNAddrArr.min.js"></script>
                ...
                if(need_pay>0){
                    ...
                    $.ajax({
                        ...
                        data: {
                            ...
                            name:$('#name').val(),
                            tel:$('#tel').val(),
                            address:$('.prov').val()+$('.city').val()+$('.dist').val()+$('#address').val()
                        },
                    })
                    .done(function(res) {
                        console.log(res);
