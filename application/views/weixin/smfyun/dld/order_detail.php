...
<div class="tab-body list-all">
  <?php foreach ($orders as $k => $v):?>
    ...
    <div class="content-head">
      <div class="head-top">
        <div class="phonenumber"><img src="/qwt/dld/img/lisense.png">收货人：<?=$v->receiver_name?>(手机号：<?=$v->receiver_mobile?>)</div>
