  ...
  <body class="hold-transition skin-red sidebar-mini">
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <!-- Logo -->
        <a href="/qwtwzba/home" class="logo">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview <?=isActive(array('items', 'orders'))?>">
              ...
              <ul class="treeview-menu">
                <li class="<?=isActive('orders')?>"><a href="/qwtwzba/orders"><i class="fa fa-circle-o"></i> <span>兑换记录</span> </a></li>
                <li class="<?=isActive('items')?>"><a href="/qwtwzba/items"><i class="fa fa-circle-o"></i> <span>奖品管理</span> </a></li>
              </ul>
            </li>
            -->

            <!-- <li class="<?=isActive('stats')?>"><a href="/qwtwzba/stats"><i class="fa fa-bar-chart"></i> <span>活动统计</span></a></li> -->
            <?php if($_SESSION['wzba']['bid']&&$todo['flag']==1):?>
            <li class="treeview">
            ...
            <li class="treeview <?=isActive(array('information','flowcenter','flowcenter_history','buymentrecord'))?>">
              ...
              <ul class="treeview-menu">
                <li class="<?=isActive('information')?>"><a href="/qwtwzba/information"><i class="fa fa-circle-o"></i> <span>基本信息</span> </a></li>
                <li class="<?=isActive(array('flowcenter','flowcenter_history'))?>"><a href="/qwtwzba/flowcenter"><i class="fa fa-circle-o"></i> <span>直播流量中心</span> </a></li>
                <li class="<?=isActive('buymentrecord')?>"><a href="/qwtwzba/buymentrecord"><i class="fa fa-circle-o"></i> <span>购买记录</span> </a></li>
              </ul>
            </li>
            ...
            <li class="treeview <?=isActive(array('setgoods','other_setgood'))?>">
              ...
              <ul class="treeview-menu">
                <li class="<?=isActive('setgoods')?>"><a href="/qwtwzba/setgoods"><i class="fa fa-circle-o"></i> <span>有赞商品管理</span> </a></li>
                <li class="<?=isActive('other_setgood')?>"><a href="/qwtwzba/other_setgood"><i class="fa fa-circle-o"></i> <span>其他商品管理</span> </a></li>
              </ul>
            </li>
            <!-- <li class="<?=isActive('marketing')?>">
              <a href="/qwtwzba/marketing">
                <i class="fa fa-dashboard"></i>
                <span>营销模块</span>
              </a>
            </li> -->
            <li class="treeview <?=isActive(array('marketing','lottery','lottery_history'))?>">
              ...
              <ul class="treeview-menu">
                <li class="<?=isActive('marketing')?>"><a href="/qwtwzba/marketing"><i class="fa fa-circle-o"></i> <span>首次进直播间送优惠券</span> </a></li>
                <?php if($_SESSION['wzba']['bid']==1):?>
                <li class="<?=isActive(array('lottery','lottery_history'))?>"><a href="/qwtwzba/lottery"><i class="fa fa-circle-o"></i> <span>幸运抽奖轮盘</span> </a></li>
              <?php endif?>
              </ul>
            </li>
            <li class="<?=isActive('qrcodes')?>"><a href="/qwtwzba/qrcodes"><i class="fa fa-user"></i> <span>用户管理</span></a></li>
            <li class="<?=isActive('analyze')?>"><a href="/qwtwzba/analyze"><i class="fa fa-dashboard"></i> <span>直播分析</span></a></li>
            <li class="treeview <?=isActive(array('download','download_ios'))?>">
              ...
              <ul class="treeview-menu">
                <li class="<?=isActive('download')?>"><a href="/qwtwzba/download"><i class="fa fa-circle-o"></i> <span>安卓端APK下载</span> </a></li>
                <li class="<?=isActive('download_ios')?>"><a href="/qwtwzba/download_ios"><i class="fa fa-circle-o"></i> <span>IOS端应用下载</span> </a></li>
              </ul>
            </li>
              <?php endif?>
              <?php if($_SESSION['wzba']['admin'] >= 1&&$_SESSION['wzba']['aid']&&$todo['flag']==2):?>
              <li class="<?=isActive('logins')?>"><a href="/qwtwzbb/logins"><i class="fa fa-user"></i> <span>账号管理</span></a></li>
              <li class="<?=isActive('admins')?>"><a href="/qwtwzbb/admins"><i class="fa fa-user"></i> <span>代理商管理</span></a></li>
              <li class="<?=isActive('sales')?>"><a href="/qwtwzbb/sales"><i class="fa fa-user"></i> <span>销售管理</span></a></li>
            <?php endif?>
          </ul><!-- /.sidebar-menu -->
        </section>
        <!-- /.sidebar -->
