...
<head>
    ...
    <script src="../qwt_live/file/hm.js"></script>
    <script src="../qwt_live/file/share.html_aio_3f0c1c7.js"></script>
    <script src="../qwt_live/file/jweixin-1.0.0.js"></script>
    <?php if($wzbdebug=='start'):?>
    <script type="text/javascript" src="https://www.w3cways.com/demo/vconsole/vconsole.min.js?v=2.2.0"></script>
    <?php endif?>
    <link rel="stylesheet" href="../qwt_live/file/share.html_aio_d74d816.css">
    <style type="text/css">
...
dl {
    ...
    @media only screen and (device-width:375px) and (device-width:812px){
        #video{
...
<?php endif?>
    <div class="shadow">
        <img src="../qwt_live/file/shadow_0e2a4b5.png" class="shadow" style="position:absolute;width:100%;display:none;margin:0 auto;z-index: 999;">
    </div>
    <div id="rt-share">
        <img src="../qwt_live/file/rt-share_95173d3.png" style="width:100%;">
    </div>
    <figure id="video-box" class="vod-box-pl" style="height: 568px;">
        <video x5-video-player-type="h5" x5-video-player-fullscreen="true" style="background: rgb(0,0,0);" id="video" loop="loop" width="100%" preload="auto" poster="" webkit-playsinline="true" playsinline="true" x-webkit-airplay="true" src="http://live.smfyun.com/AppName/<?=$_SESSION['qwtwzb']['bid']?>.m3u8"></video>
        ...
        <!-- <div class="barragebtn">
            <a class="blindflow"><img src="../qwt_live/file/barrage.png" style="width:23px;"><img class="barrageoff" src="../qwt_live/file/barrageoff.png"></a>
        </div> -->
        </div>
    ...
    <!--喜欢按钮-->
        ...
        <a id="likebtn" type="button" class="like" value="喜欢">
            <img class="likeicon" src="../qwt_live/file/like.png">
        </a>
    <!--喜欢按钮结束-->
    <!--转盘开始-->
    <?php if(($result['isonline']==1&&$lswitch==1)||$wzbdebug=='start'):?>
    <div class="platebtn">点击抽奖</div>
    <img src="../qwt_live/images/xiexiecanyu.png" id="shan-img" style="display:none;" />
    <img src="/qwtwzb/images/lottery/<?=$data1->id?>.v<?=time()?>.jpg" id="diy1-img" style="display:none;" />
    <img src="/qwtwzb/images/lottery/<?=$data2->id?>.v<?=time()?>.jpg" id="diy2-img" style="display:none;" />
    <!-- <img src="http://<?=$_SERVER['HTTP_HOST']?>/qwtwzba/images/lottery/<?=$data1->id?>.v<?=time()?>.jpg" id="diy1-img" style="display:none;" /> -->
    <img src="/qwtwzb/images/lottery/<?=$data3->id?>.v<?=time()?>.jpg" id="diy3-img" style="display:none;" />
    <img src="/qwtwzb/images/lottery/<?=$data4->id?>.v<?=time()?>.jpg" id="diy4-img" style="display:none;" />
    <div class="banner" style="margin-top: 35%">
        <div class="turnplate" style="background-image:url(../qwt_live/images/cj_bg.png);background-size:100% 100%;">
            <canvas class="item" id="wheelcanvas" width="422px" height="422px"></canvas>
            <img class="pointer" src="../qwt_live/images/jt2.png"/>
        </div>
        <!-- <div class="huodongshuoming">
            <img class="huodongshuomingbtn" src="../qwt_live/images/huodongshuoming.png" style="margin-left:25%;width:50%;" />
        </div> -->
    </div>
    <!-- <div id="huodongguize">
        <img src="../qwt_live/images/huodongguize.png" class="red-img">
        <span>
            <p>1.</p>
        </span>
    </div> -->
    <div id="mark">
        <img src="../qwt_live/images/gongxizhongjiang.png" class="red-img">
    ...
    <div id="mark2">
        <img src="../qwt_live/images/meiyouzhongjiang.png" class="red-img">
...
<?php endif?>
    <!--转盘结束-->
            ...
            <div class="left-side-cartoon">
                <div class="effect hide" data-amount="14" id="" data-current="14" style="margin-left: -8rem;">
                    <div class="wrap-cartoon">
                        <figure class="cartoon-avatar"> <img src="../qwt_live/file/3e242d642d482244ad640f041d1836d7.jpg"> </figure>
                ...
                <div class="effect hide" data-amount="1" id="" data-current="1" style="margin-left: -8rem;">
                    <div class="wrap-cartoon">
                        <figure class="cartoon-avatar"> <img src="../qwt_live/file/.jpg"> </figure>
                        <p class="nickname"><span class="rank r-9"></span>心语😔</p>
                        <p class="desc">送出了棒棒糖</p>
                        <figure class="gift"> <img src="../qwt_live/file/cc25568bfb3d2f63092b285f9552c85f.png"> </figure>
        ...
        <section class="btm-menu">
            <div class="wrap-menu">
                <?php if($result['isonline']==1||$wzbdebug=='start'):?>
                ...
                <div class="w-share" style="margin:auto .36rem auto auto;float:right;width:2.2rem;">
                    ...
                    <img src="../qwt_live/file/shopping.png">
                    </figure>
                </div>
                <!-- <div class="w-gift">
                    <figure><img src="../qwt_live/file/gift_3c4198a.png" alt=""></figure>
                </div> -->
            </div>
        </section>
        <div class='mask'>
        ...
        <section class="sns-share" style='display:none;'>
            <div class="sns-hd">
                <div class="goods-count">
                    <img src="../qwt_live/file/shopicon.png" style="height:100%;">
                    <span>全部商品</span>
                ...
                <div id='scroll'>
                    ...
                    <div class="goods" data-url="<?=$v->url?>">
                        ...
                        <?php if($v->type==1):?>
                            <img src="<?=$v->pic?>">
                        <?php else:?>
                            <img src="/qwtwzb/dbimages/setgood/<?=$v->id?>.v<?=$v->time?>.jpg">
                        <?php endif?>
                        </figure>
        ...
        <?php if($config['shop_url']):?>
            <div class="sns-ft">
                <img src="../qwt_live/file/entershop.png" class="enter-shop" data-url="<?=$config['shop_url']?>">
            </div>
        <?php endif?>
            <!-- <h4 class="back">返回</h4> -->
        </section>
        <div class="pause" style="display: none;">
            <div class="pause-wrap">
                <figure>
                    <img src="../qwt_live/file/pause_b5a4c7c.png" alt="">
                </figure>
            </div>
        </div>
    ...
    <div class="leadReece" <?=$result['coupon']['title']&&$result['isonline']==1?'style="display: true;"':'style="display: none;"'?>>
        ...
        <figure>
            ...
            <img style="position: absolute;width: 80%;height: auto;top: 35%;left: 10%;" src="../qwt_live/file/lucky-gift.png" alt="">
        </figure>
    </div>
    <!-- 优惠券下发错误情况 -->
    <div class="leadReece" <?=$result['coupon']['error']&&$result['isonline']==1?'style="display: true;"':'style="display: none;"'?>>
        <div class="close"></div>
        <figure><img style="width: 80%;height: auto;margin-left: 10%;margin-top: 30%;" src="../qwt_live/file/lucky-gift1.png" alt=""></figure>
    ...
    <div class="guide-pay" style="display:block">
        <figure style="width:100%;height:100%;">
            <img src="../qwt_live/file/weikaibo.png">
    ...
    <div class="yellow" style="display:none">
        <figure style="width:100%;height:100%;">
            <img style="width: 100%;" src="../qwt_live/file/yellow.png">
        </figure>
    </div>
    <div class="login">
...
<div class="trolley" style="display:none;overflow: hidden; position: absolute; z-index: 1000; background: white; bottom: 0px; left: 0px; right: 0px; visibility: visible; transform: translate3d(0px, 0px, 0px); transition: all 300ms ease; opacity: 1;">
    ...
    var shareConfig = {
            wx: {
                ...
                imgUrl: "<?=$result['wsimg']?>",
                link: "http://<?=$_SERVER['HTTP_HOST']?>/qwtwzb/live?bid=<?=$result['bid']?>"
            },
            sObj: {
            ...
            url: {
                "send_live_comment": "/qwtwzb/send_live_comment",
    ...
    <script src="../qwt_live/file/iscroll.js"></script>
    <script src="../qwt_live/file/awardRotate.js"></script>
    ...
    $(document).on('click','.subscribe',function(){
        ...
        .done(function(res) {
            ...
            if(res=='订阅成功'){
                $('.subscribe').text('已订阅')
                $.ajax({
                    url: '/qwtwzb/send_live_comment',
                    type: 'post',
                    async: false,
                    dataType: 'text',
                    data: {sub: 1 ,openid: shareConfig.sObj.openid,bid: shareConfig.sObj.bid,sid:<?=$_SESSION['qwtwzb']['sid']?>},
                })
                .done(function(res) {
                    console.log(res);
                })
    ...
    <script src="../qwt_live/file/share.html_aio_2_436fe5c.js"></script>
    <script type="text/javascript">
        ...
        if(buy_good == 1){
            ...
            var that = this;
             $.ajax({
                ...
                async: false,
                dataType: 'text',
                data: {buy: 1 ,openid: shareConfig.sObj.openid,bid: shareConfig.sObj.bid,sid:<?=$_SESSION['qwtwzb']['sid']?>},
             })
             .done(function(res) {
   ...
   setInterval(function(){
    ...
    .done(function(res) {
        ...
        setTimeout(function(n){
            ...
            $('.likeimg>img:eq(' + index + ')').attr('src','../qwt_live/file/'+num+'.png')
            $(".likeimg>img").animate({
                bottom:"400px",
                opacity:"0",
                right: rand,
...
<?php endif?>
    ...
    <script src="../qwt_live/file/mlink.min.js"></script>
    <script src="../qwt_live/file/yxa.min.js"></script>
</body>
