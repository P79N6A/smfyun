    ...
    <div class="js-list">
        <a class="block-item">
            <p class="line-height-30">
                <div style="text-align:center"><br><br><br><br><br><br><br><br>没有记录</div>
            </p>
        </a>
    </div>
    ...
    <div class="block block-order animated js-order-item">
        ...
        <div class="block block-list border-top-0 border-bottom-0 score_list font-size-12">
            <div class="block-item border-none name-card name-card-3col score-name-card clearfix">
                <a href="/qwtfxb/order/<?=$trade->id?>" class="thumb"><img src="<?=$trade->pic_thumb_path?>"></a>
                <div class="detail"><a href="/qwtfxb/order/<?=$trade->id?>"><h3 class="ellipsis"><?=$trade->title?></h3></a></div>
        ...
        <div class="block block-list border-top-0 border-bottom-0" style="padding: 0 10px;margin: 10px 0;">
            ...
            <div class="pull-right font-size-12"><span class="c-orange">￥<?=$score->score?></span></div>
        </div>
