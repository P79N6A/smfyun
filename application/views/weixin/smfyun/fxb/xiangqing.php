  ...
  <body class="page-detail" data-page="detail" ontouchstart="">
    <div class="view js-page-view" id="page-view-detail">
        <div class="detail-header" id="detail-header">
              ...
              <div style="width: auto;"> <img src="http://<?=$_SERVER['HTTP_HOST']?>/qwtfxb/images/item/<?=$item->id?>.v<?=$item->lastupdate?>0.jpg" alt="<?=$item->name?>">
           ...
           <?php if ($dlimit==1):?>
                ...
                <?php elseif ($user2['shscore'] < $item->score):?>
                ...
                <?php else:?>
                <a href="/qwtfxb/neworder/<?=$item->id?>" class="pay-btn" style="width:35%">立即兑换</a>
                <?php endif?>
