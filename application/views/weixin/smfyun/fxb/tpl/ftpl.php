    ...
    <div class="wrp">
          ...
          <div class="data_overview" style="padding:20px 0 20px;">
            <ul class="overview_list">
              ...
              <li class="overview_item">
                ...
                <p class="number" class="shscore">
                  <?=number_format($result['shscore'])?>
                </p>
                </div>
              </li>
            </ul>
      ...
      <div class="profile_fun">
            ...
            <ul id="js_menu" class="menu_list">
                ...
                <li class="menu_item">
                    <a href="/qwtfxb/score" class="inner_item">
                        <span class="icon_menu"><img src="http://yingyong.smfyun.com/dkl/img/score.png"></span>
                        <p class="text_menu">我的<?=$config['title5']?></p>
                     </a>
                </li>
                <li class="menu_item">
                    <a href="/qwtfxb/items" class="inner_item">
                        <span class="icon_menu"><img src="http://yingyong.smfyun.com/dkl/img/shop.png"></span>
                        <p class="text_menu">兑换中心</p>
                     </a>
                </li>
                <li class="menu_item" >
                    <a href="/qwtfxb/shorders" class="inner_item" style="border-right:1px solid #f6f6f6;">
                ...
                <!-- <li class="menu_item" >
                    <a href="<?='http://'.$_SERVER["HTTP_HOST"].'/qwtfxb/storefuop/'.$bid?>" class="inner_item" style="border-right:1px solid #f6f6f6;">
                        <span class="icon_menu"><img src="http://yingyong.smfyun.com/dkl/img/list.png"></span>
                        <p class="text_menu">推荐商品</p>
                     </a>
                </li> -->

                <li class="menu_item" >
                    <a href="/qwtfxb/top" class="inner_item">
                        <span class="icon_menu"><img src="http://yingyong.smfyun.com/dkl/img/rank.png"></span>
                        <p class="text_menu"><?=$config['title5']?>排行</p>
                     </a>
                </li>
