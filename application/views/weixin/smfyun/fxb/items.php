...
<html><head>
    ...
    <link rel="stylesheet" type="text/css" href="../qwtfxb/prize/css/didi.css"> -->
    <!-- <link rel="stylesheet" type="text/css" href="../qwtfxb/prize/css/index.css"> -->
    <link rel="stylesheet" type="text/css" href="../qwtfxb/prize/css/swiper.css">
  <style>
.text_menu
{
  font-size: 15px;
...
?>
                ...
                <a href="/qwtfxb/item/<?=$item->id?>">
                    <div class="media">
                        <img src="http://<?=$_SERVER['HTTP_HOST']?>/qwtfxb/images/item/<?=$item->id?>.v<?=$item->lastupdate?>0.jpg" alt="<?$item->name?>">
                    </div>
                    <div class="info">
                        <span class="name">
                            <?=$item->name?>
                        ...
                        <span class="price">
                            <b><?=$item->score?></b><?=$config['scorename']?>
                        </span>
                    </div>
                    </a>
                </div>
