        ...
        <li>
            <div class="cd-single-item">
                <ul class="cd-slider-wrapper">
                    <li class="selected"><img src="<?=$config['cdn']?>/qwtxdb/images/item/<?=$item->id?>.v<?=$item->lastupdate?>.jpg" alt="<?=$item->name?>"></li>
                </ul>
            </div> <!-- .cd-single-item -->
            <div class="cd-item-info">
                <b><a href="/qwtxdb/neworder/<?=$item->id?>"><?=$item->name?></a></b>
                        ...
                        if(res.error){
                            ...
                            wx.chooseWXPay({
                                ...
                                success: function (res2) {
                                    ...
                                    // });
                                    window.location.href = 'http://<?=$_SERVER['HTTP_HOST']?>/qwtxdb/order';
                                }
                            });
                        }
                    })
