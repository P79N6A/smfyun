...
/*   body{
   ...
   <body style="width: 1920px; height: 1080px;  transform-origin: left top 0px;background:url('../yyx/dist/img/bg.jpg');background-size:cover;visibility:hidden">
    <div class="line0"><img style="position:relative;bottom:10px;height: 100%;display: inline;" src="../yyx/dist/img/youjian.png"><div style="position: relative;top: -35px;margin-left: 1%;">有间海淘实时交易数据中心</div></div>
    <div class='line1'>
