...
/*   body{
   ...
   <body style="width: 1920px; height: 1080px;  transform-origin: left top 0px;background:url('../yyx/dist/img/bgnewnew.png');background-size:cover;visibility:hidden">
    <div class="line0"><img style="height: 100%;display: inline;" src="../yyx/dist/img/smfyun.png"><div style="position: relative;top: -35px;margin-left: 1%;">神码浮云商城实时交易数据中心</div></div>
    <div class='line1'>
       <div class="border" style="width:25%;height:100%;">
       <div class="title" style="margin-left:5px;">订单来源</div>
            <div id="source" style="width:100%;height:100%;padding-top:10%;">
       </div>
       </div>
       <div id="today" style="width:50%;height:100%;vertical-align: top;padding:0 10px 0 10px;text-align:center;padding-top:5%;">
            <!-- <div class="title">神码浮云商城数据中心</div> -->
       ...
       <div id="goal" style="width:100%;height:40px;margin-top: 20px;">
       ...
       <div class="title" style="margin-bottom: 10px;margin-top: 90px;">地区销售排行</div>
       <div id="area" style="width:100%;height:510px;margin-top:20px;">
       </div>
       </div>
    </div>
    <div class='line2'>
       ...
       <div class="line3">
           <div class='border' style="width:100%;height:100%;vertical-align: top;">
               <div class="title" style="margin-left:5px;">热销商品销量排行</div>
                <table style="table-layout:fixed;height: 230px;margin-top:20px;margin-bottom:20px;">
                  <thead>
                    <tr>
                      <th style="width:5%;"></th>
