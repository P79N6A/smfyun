...
<a href="/fxb/money">
    ...
    <div class="block block-list block-list-actions" style="margin: 20px 0 -1px 0;">
        <a class="block-item clearfix arrow" href="/fxb/score"><p class="c-black font-size-14">收支明细</p></a>
        <a class="block-item clearfix arrow" href="/fxb/top"><p class="c-black font-size-14">业绩排行</p></a>
    ...
    <div class="action-container" style="margin:20px 0"><a href="/fxb/money" class="js-spread btn btn-block btn-green">我要提现</a></div>
