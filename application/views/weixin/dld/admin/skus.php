    ...
    <div class="col-xs-12">
        <div class="box box-success">
            ...
            <div class="box-body">
                    ...
                    <div class="alert alert-danger">分享文案设置</div>
                    <div class="row">
                      <div class="col-lg-6 col-sm-6">
                        <div class="form-group">
                          <label>邀请新代理时候分享朋友圈标题文案</label>
                          <input type="text"  class="form-control" id="timeline" name="share[timeline]" value="<?=$config['timeline']?>" >
                        </div>
                        <div class="form-group">
                          <label>邀请新代理时候分享给朋友描述文案</label>
                          <input type="text"  class="form-control" id="appmessage" name="share[appmessage]" value="<?=$config['appmessage']?>" >
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-lg-12 col-sm-6">
                        <div class="form-group">
                          <label>代理申请提示购买文案：</label>
                          <input type="text" class="form-control" id="buytip" name="quest[buytip]" value="<?=$config['buytip']?>" >
                        </div>
                      </div>
                    </div>
                    <div class="row">
                  ...
                  ?>
                    <div class="row">
                      <div class="col-lg-3 col-sm-3">
                        <div class="form-group">
                          <input type="number" step="0.01" class="form-control" id="start<?=$v->lv?>" maxlength="10" name="menu[key_c<?=$name1?>_dld]" value="<?=$v->money1?>" readonly="readonly">
                        </div>
                      </div>
                      <div class="col-lg-3 col-sm-3">
                        <div class="form-group">
                          <input type="number" step="0.01" class="form-control" id="end<?=$v->lv?>" maxlength="10" name="menu[key_c<?=$name2?>_dld]" value="<?=$v->money2?>">
                        </div>
                      </div>
                     <div class="col-lg-3 col-sm-3">
                        <div class="form-group">
                          <input type="number" step="0.01" class="form-control" id="rate<?=$v->lv?>" maxlength="200" name="menu[value_c<?=$v->lv?>_dld]" value="<?=$v->scale?>">
                        </div>
                      </div>
                    </div>
                  <?php endforeach;?>
                    ...
                    <div class="row">
                      <div class="col-lg-6 col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" value="http://<?=$_SERVER["HTTP_HOST"]?>/dld/index_oauth/<?=$bid?>/code" readonly="readonly">
                        </div>
                      </div>
                    </div>
...
<script type="text/javascript">
  ...
  function add(){
    ...
    $('.input-box').append("<div class=\"row\">"+
                      "<div class=\"col-lg-3 col-sm-3\">"+
                        "<div class=\"form-group\">"+
                          "<input type=\"number\" step=\"0.01\" class=\"form-control\" id=\"start"+b+"\" maxlength=\"10\" name=\"menu[key_c"+c+"_dld]\" value=\"\" readonly=\"readonly\">"+
                        "</div>"+
                      "</div>"+
                      "<div class=\"col-lg-3 col-sm-3\">"+
                        "<div class=\"form-group\">"+
                          "<input type=\"number\" step=\"0.01\" class=\"form-control\" id=\"end"+b+"\" maxlength=\"10\" name=\"menu[key_c"+d+"_dld]\" value=\"\">"+
                        "</div>"+
                      "</div>"+
                     "<div class=\"col-lg-3 col-sm-3\">"+
                        "<div class=\"form-group\">"+
                          "<input type=\"number\" step=\"0.01\" class=\"form-control\" id=\"rate"+b+"\" maxlength=\"200\" name=\"menu[value_c"+b+"_dld]\" value=\"\">"+
                        "</div>"+
                      "</div>"+
                    "</div>");
    count();
