          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="cfg_yz">
               ...
               <!--  <div class="callout callout-success">
                  <h4>有赞插件配置信息</h4>
                  <p><b>插件 url：</b> <u><?='http://'.$_SERVER["HTTP_HOST"].'/api/dld/'.$_SESSION['dlda']['user'];?></u></p>
                ...
                <form role="form" method="post">
                  <div class="box-body">
                    ...
                    <!-- <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="scene_id" placeholder="输入带参数二维码的 scene_id" name="cfg[scene_id_dld]" value="<?=$config['scene_id_dld']?>">
                    </div> -->
                    <p class="alert alert-danger alert-dismissable">注意：请务必点击有赞一键授权，否则功能将无法使用</p>
                    <?php if($oauth==1):?>
                  <div class="lab4">
                    <a href='/dlda/oauth'><button type="button" class="btn btn-warning">点击一键授权有赞</button></a>
                  </div>
                  <br>
                  <?else:?>
                  <div class="lab4">
                    <a href='/dlda/oauth'><button type="button" class="btn btn-warning">点击重新授权有赞</button></a>
                  </div>
                  <?endif?>
                  ...
                  <!--   <div class="row">
                    <div class="col-lg-3 col-sm-3">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="menu0" placeholder="生成海报" maxlength="10" name="menu[key_dldqrcode]" value="<?=$config['key_dldqrcode']?>">
                      </div>
                    </div>
                    </div>
                    ...
                    <div class="col-lg-8">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="menu1" placeholder="资产查询" maxlength="10" name="menu[key_dldscore]" value="<?=$config['key_dldscore']?>">
                      </div>
                    </div>
                    </div> -->
                    <div class="row">
                    <div class="col-lg-8">
                      <div class="form-group">
                        ...
                        <input readonly="" type="text" class="form-control" id="menu2" maxlength="10" value="<?='http://'.$_SERVER["HTTP_HOST"].'/dld/index_oauth/'.$_SESSION['dlda']['bid'].'/memberpage'?>">
                      </div>
                    </div>
                    </div>
                    <div class="row">
                    <div class="col-lg-8">
                      <div class="form-group">
                        ...
                        <input readonly="" type="text" class="form-control" id="menu2" maxlength="10" value="<?='http://'.$_SERVER["HTTP_HOST"].'/dld/index_oauth/'.$_SESSION['dlda']['bid'].'/form'?>">
                      </div>
                    </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-lg-3 col-sm-3">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="menu10" placeholder="自定义 KEY1" maxlength="10" name="menu[key_c1_dld]" value="<?=$config['key_c1_dld']?>">
                        </div>
                      </div>
                     <div class="col-lg-9 col-sm-9">
                        <div class="form-group">
                          <label for="v10">点击后回复文字（使用 \n 换行）</label>
                          <input type="text" class="form-control" id="v10" placeholder="点击自定义 KEY1 后的回复文字" maxlength="200" name="menu[value_c1_dld]" value="<?=$config['value_c1_dld']?>">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-lg-3 col-sm-3">
                        <div class="form-group">
                          <input type="text" class="form-control" id="menu11" placeholder="自定义 KEY2" maxlength="10" name="menu[key_c2_dld]" value="<?=$config['key_c2_dld']?>">
                        </div>
                      </div>
                     <div class="col-lg-9 col-sm-9">
                        <div class="form-group">
                          <input type="text" class="form-control" id="v11" placeholder="点击自定义 KEY2 后的回复文字" maxlength="200" name="menu[value_c2_dld]" value="<?=$config['value_c2_dld']?>">
                        </div>
                      </div>
                    </div>
                   ...
                   <div class="row">
                      <div class="col-lg-3 col-sm-3">
                        <div class="form-group">
                          <input type="text" class="form-control" id="menu12" placeholder="自定义 KEY3" maxlength="10" name="menu[key_c3_dld]" value="<?=$config['key_c3_dld']?>">
                        </div>
                      </div>
                     <div class="col-lg-9 col-sm-9">
                        <div class="form-group">
                          <input type="text" class="form-control" id="v12" placeholder="点击自定义 KEY3 后的回复文字" maxlength="200" name="menu[value_c3_dld]" value="<?=$config['value_c3_dld']?>">
                        </div>
                      </div>
                    </div> -->
            ...
            <div class="tab-pane" id="cfg_text">
                ...
                <form role="form" method="post" enctype="multipart/form-data">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <label for="dld_desc">公告文字：</label>
                      <input class="form-control" id="dld_desc" name="text[desc]" value="<?=$config['desc']?>"></input>
                    </div>

                    <div class="form-group">
                      <label for="dld_url">公告链接网址（没有则不设置）：</label>
                      <input type="text" class="form-control" id="dld_url" name="text[dld_url]" placeholder="http://" value="<?=$config['dld_url']?>">
                    </div>
