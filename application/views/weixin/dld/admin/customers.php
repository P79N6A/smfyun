...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="/dlda/qrcodes">客户管理</a></li>
         ...
         <div class="box-tools">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                $num=ORM::factory('dld_trade')->where('bid','=',$customer->bid)->where('deletedd','=',0)->where('openid','=',$customer->openid)->count_all();
                $allmoney=DB::query(Database::SELECT,"SELECT SUM(payment) as allmoney from dld_trades where bid=$customer->bid and deletedd = 0 and `openid` = '$customer->openid' ")->execute()->as_array();
                    $allmoney=$allmoney[0]['allmoney'];
                  $fname=ORM::factory('dld_qrcode')->where('bid','=',$customer->bid)->where('openid','=',$customer->fopenid)->where('lv','=',1)->find()->nickname;
                ?>
                <tr>
                  ...
                  <td><a href="/dlda/history_trades?flag=cnum&qid=<?=$customer->id?>"><?=$num?></td>
