...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="/dlda/qrcodes">订单记录</a></li>
        ...
        <div class="box box-success">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                $information=ORM::factory('dld_qrcode')->where('id','=',$v->qid)->find();
                $fuser = ORM::factory('dld_qrcode')->where('bid', '=', $v->bid)->where('openid', '=', $v->fopenid)->where('lv','=',1)->find();
                ?>
                <tr>
                  <td><?=$v->title?></td>
                  <td><?=$v->pay_time?></td>
