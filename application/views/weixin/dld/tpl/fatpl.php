...
<!--             <li class="treeview <?=isActive(array('items', 'shorders'))?>">
           ...
           <li class="treeview <?=isActive(array('stats_totle','stats_goods'))?>">
            ...
            <ul class="treeview-menu">
              <li class="<?=isActive('stats_totle')?>"><a href="/dlda/stats_totle"><i class="fa fa-circle-o"></i> <span>概况</span> </a></li>
              <li class="<?=isActive('stats_goods')?>"><a href="/dlda/stats_goods"><i class="fa fa-circle-o"></i> <span>商品统计</span></a></li>
            </ul>
          </li>
