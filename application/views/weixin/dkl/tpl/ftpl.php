      ...
      <div class="profile_fun">
            ...
            <ul id="js_menu" class="menu_list">
              ...
              <? else:?>
                <li class="menu_item" >
                    <a href="/dkl/score" class="inner_item">
                        <span class="icon_menu"><img src="http://jfb.dev.smfyun.com/dkl/img/score.png"></span>
                        <p class="text_menu"><?=$scorename?>明细</p>
                     </a>
                </li>
                <li class="menu_item">
                    <a href="/dkl/items" class="inner_item">
                        <span class="icon_menu"><img src="http://jfb.dev.smfyun.com/dkl/img/shop.png"></span>
                        <p class="text_menu"><?=$scorename?>商城</p>
                     </a>
                </li>
                <li class="menu_item" >
                    <a href="/dkl/orders" class="inner_item" style="border-right:1px solid #f6f6f6;">
                        <span class="icon_menu"><img src="http://jfb.dev.smfyun.com/dkl/img/list.png"></span>
                        <p class="text_menu">兑换明细</p>
                     </a>
                </li>
                <li class="menu_item" >
                    <a href="/dkl/top" class="inner_item">
                        <span class="icon_menu"><img src="http://jfb.dev.smfyun.com/dkl/img/rank.png"></span>
                        <p class="text_menu"><?=$scorename?>排行</p>
                     </a>
                </li>
              <? endif;?>
