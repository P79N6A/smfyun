<link rel="stylesheet" type="text/css" href="/yyx/plugins/simditor-2.2.4/styles/simditor.css" />
<?php
function convert($c){
 $c =str_replace('"', '&quot;',$c);
 echo $c;
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane" id="cfg_yz">
            <div class="callout callout-success">
              ...
              <p><b>插件 token：</b> <u>duokelai2017</u></p>
              <p><b>插件 url：</b> <u><?='http://'.$_SERVER["HTTP_HOST"].'/api/dkl/'.$_SESSION['dkla']['user'];?></u></p>
            ...
            <form role="form" method="post">
              <div class="box-body">
                ...
                <p class="alert alert-danger alert-dismissable">注意：如果需要使用批量打标签、有赞赠品、支付后生成海报、有赞积分同步功能，请务必点击有赞一键授权，否则以上功能将无法使用</p>
                <?php if($oauth==1):?>
                  <div class="lab4">
                    <a href='/dkla/oauth'><button type="button" class="btn btn-warning">点击一键授权有赞</button></a>
                  </div>
                  <br>
                  <?else:?>
                  <div class="lab4">
                    <a href='/dkla/oauth'><button type="button" class="btn btn-warning">点击重新授权有赞</button></a>
                  </div>
                  <?endif?>
              </div><!-- /.box-body -->
                ...
                <div class="row">
                  <div class="col-lg-3 col-sm-3">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="menu1" placeholder="积分查询" maxlength="20" name="menu[key_score]" value="<?=$config['key_score']?>">
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-lg-3 col-sm-3">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="menu2" placeholder="积分兑换" maxlength="20" name="menu[key_item]" value="<?=$config['key_item']?>">
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-lg-3 col-sm-3">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="menu3" placeholder="积分排行" maxlength="20" name="menu[key_top]" value="<?=$config['key_top']?>">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-lg-8">
                    <div class="form-group">
                      <label for="menu2">5.PC端核销网址</label>
                      <input readonly="" type="text" class="form-control" id="menu2" maxlength="10" value="<?='http://'.$_SERVER["HTTP_HOST"].'/dkla/veri_login/'.$_SESSION['dkla']['bid']?>">
                    </div>
                  </div>
                  </div>
                   <div class="row">
                  <div class="col-lg-8">
                    <div class="form-group">
                      <label for="menu2">6.移动端核销网址</label>
                      <input readonly="" type="text" class="form-control" id="menu2" maxlength="10" value="<?='http://'.$_SERVER["HTTP_HOST"].'/dkl/clerk_apply/'.$_SESSION['dkla']['bid']?>">
                    </div>
                  </div>
                  </div>
          ...
          <div class="tab-pane" id="cfg_text">
            ...
            <form role="form" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                if ($result['tpl']):
                  ?>
                <div class="form-group">
                  <a href="/dkla/images/cfg/<?=$result['tpl']?>.v<?=time()?>.jpg" target="_blank"><img class="img-thumbnail" src="/dkla/images/cfg/<?=$result['tpl']?>.v<?=time()?>.jpg" width="200" title="点击查看原图"></a>
                </div>
              <?php endif?>
              ...
              <div class="form-group">
                ...
                <p class="help-block">只能为 JPEG 格式，规格建议为 640*900px，最大不超过 300K，<a href="/dkl/tpl.zip" target="_blank">点击这里</a> 下载 PSD 模板自行设计。</p>
              </div>
              ...
              if ($result['tplhead']):
                ?>
              <div class="form-group">
                <a href="/dkla/images/cfg/<?=$result['tplhead']?>.v<?=time()?>.jpg" target="_blank"><img class="img-thumbnail" src="/dkla/images/cfg/<?=$result['tplhead']?>.v<?=time()?>.jpg" width="100" title="点击查看原图"></a>
              </div>
            <?php endif?>
            ...
            <div class="row">
              ...
              <label style="color:red;max-width:1000px;width:1000px;margin-bottom: 10px;padding-left:10px">注意：请核算后谨慎设置积分奖励规则，避免积分兑换奖品的门槛过低，造成不必要的损失，特别是在奖品设置时，单个奖品兑换所需的积分一定要高于首次关注奖励积分。因为运营操作不当，积分兑换门槛设置过低导致的损失，我方不予承担。</label>
            </div>
            ...
            <div class="form-group">
              <label for="rank">用户未满足生成海报条件提示文案</label>
              <textarea class="form-control" id="needtext" name="text[needtext]"><?=$config['needtext']?></textarea>
            </div>
              ...
              <div class="col-lg-2 col-sm-3">
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="goal3" name="text[text_goal3]"  value="<?=$config['text_goal3']?convert($config['text_goal3']):'恭喜您成为了「%s」的支持者~'?>">
                  </div>

                  <div class="form-group">
                    <label for="goal4">重复扫描相同二维码回复文案</label>
                    <input type="text" class="form-control" id="goal4" name="text[text_goal4]" value="<?=$config['text_goal4']?convert($config['text_goal4']):'您已经是「%s」的支持者了，不用再扫了哦'?>">
                  </div>
                  <div class="form-group">
                    <label for="send">海报生成前发送消息</label>
                    <input type="text" class="form-control" id="send" name="text[text_send]" placeholder="您的专属海报生成中，请稍等..." value="<?=convert($config['text_send'])?>">
                  </div>

                  <div class="form-group">
                    <label for="goal">直接积分奖励文案</label>
                    <input type="text" class="form-control" id="goal" name="text[text_goal]" placeholder="您的朋友「%s」成为了您的支持者！您已获得了相应的积分奖励，请注意查收。" value="<?=convert($config['text_goal'])?>">
                  </div>

                  <div class="form-group">
                    <label for="goal2">间接积分奖励文案</label>
                    <input type="text" class="form-control" id="goal2" name="text[text_goal2]" placeholder="您的朋友「%s」又获得了一个新的支持者！" value="<?=convert($config['text_goal2'])?>">
                  </div>
            ...
            <div class="tab-pane" id="cfg_zero">
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          ...
                          <a href="<?php echo URL::site("dkla/empty")?>?DELETE=1" class="btn btn-outline">确认清空</a>
                        </div>
                      </div><!-- /.modal-content -->
                    </div><!-- /.modal-dialog -->
                  </div><!-- /.modal -->
              ...
              <div class="tab-pane" id="cfg_area">
                ...
                <!-- // <script src="/dkl/plugins/jQuery/jquery.js"></script> -->
                <script src="http://cdn.jfb.smfyun.com/dkl/plugins/citySelect/jquery.cityselect.js"></script>
                <script src="/dkl/plugins/citySelect/city.min1.js"></script>
                <script type="text/javascript">
                  $("#city1").citySelect({
                    prov:'',
                    city:'',
