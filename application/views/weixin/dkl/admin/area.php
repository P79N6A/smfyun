      ...
      <div class="nav-tabs-custom">
        ...
        <div class="tab-content">
              ...
              <div class="tab-pane" id="cfg_area">
                ...
                <?php endif?>
                <?php if ($result['err1']):?>
                  <div class="alert alert-warning alert-dismissable"><i class="icon fa fa-check"></i>文件已更新！!</div>
                <?php endif?>
                <form role="form" method="post" onsubmit="return toVaild()" enctype="multipart/form-data">
                  ...
                  <?php if($_SESSION['dkla']['admin'] >= 1):?>
                    <!-- <div class="form-group">
                      <label for="txt">JS安全域名文件</label><?php if($result['txt']) echo ' <span class="label label-warning">已上传</span>'?>
                      <input type="file" id="txt" name="txt" accept="text/txt" class="form-control">
                      <p class="help-block">mp后台【公众号设置】【功能设置】JS安全域名设置下载所需要的txt文件进行上传</p>
                    </div> -->
                  <?php endif?>
