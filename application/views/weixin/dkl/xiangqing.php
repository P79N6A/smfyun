  ...
  <body class="page-detail" data-page="detail" ontouchstart="">
    <div class="view js-page-view" id="page-view-detail">
        <div class="detail-header" id="detail-header">
              ...
              <div style="width: 320px;"> <img src="http://cdn.jfb.smfyun.com/dkl/images/item/<?=$item->id?>.v<?=$item->lastupdate?>0.jpg" alt="<?=$item->name?>">
           ...
           <div id="pay-bar" class="pay-bar"> 单价：
            <span class="pay-total js-total-price">
             <b class="coins"><?=$item->score?></b><?=$scorename?>
           </span>
           <?php if ($dlimit==1):?>
                ...
                <?php else:?>
                <a href="/dkl/neworder/<?=$item->id?>" class="pay-btn">立即兑换</a>
                <?php endif?>
