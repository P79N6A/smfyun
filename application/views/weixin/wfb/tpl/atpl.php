        ...
        <nav class="navbar navbar-static-top" role="navigation">
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown tasks-menu<?=$todo['all'] ? '' : ' hidden'?>">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li>
                    <ul class="menu">
                    <?php if($todo['users']):?>
                    <li><a href="/wfba/qrcodes"><i class="fa fa-users text-green"></i> <?=$todo['users']?> 个用户参与</a></li>
                    <li><a href="/wfba/qrcodes?ticket=1"><i class="fa fa-heart text-green"></i> <?=$todo['tickets']?> 个用户已生成海报</a></li>
                    <?php endif?>

                    <?php if($todo['items']):?>
                    <li><a href="/wfba/orders"><i class="fa fa-shopping-cart text-green"></i> <?=$todo['items']?> 条待处理兑换</a></li>
                    <?php endif?>

                    </ul>
                  </li>
                  <li class="footer">
                    <a href="/wfba/orders">查看所有</a>
                  </li>
                </ul>
              </li>
              ...
              <li class="dropdown user user-menu">
                <!-- Menu Toggle Button -->
                <a href="/wfba/logout" class="dropdown-toggle">
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="<?=isActive('home')?>"><a href="/wfba/home"><i class="fa fa-dashboard"></i> <span>基础设置</span></a></li>
            ...
            <li class="treeview <?=isActive(array('items', 'orders'))?>">
              ...
              <ul class="treeview-menu">
                <li class="<?=isActive('orders')?>"><a href="/wfba/orders"><i class="fa fa-circle-o"></i> <span>兑换记录</span> </a></li>
                <li class="<?=isActive('items')?>"><a href="/wfba/items"><i class="fa fa-circle-o"></i> <span>奖品管理</span> </a></li>
              </ul>
            </li>

            <li class="<?=isActive('stats_totle')?>"><a href="/wfba/stats_totle"><i class="fa fa-bar-chart"></i> <span>数据统计</span> </a></li>
           <?php if($_SESSION['wfba']['bid'] == 2345):?>
             <li class="<?=isActive('he_totle')?>"><a href="/wfba/he_totle"><i class="fa fa-bar-chart"></i> <span>核销数据</span> </a></li>
            <?php endif;?>
            <!-- <li class="<?=isActive('stats')?>"><a href="/wfba/stats"><i class="fa fa-bar-chart"></i> <span>活动统计</span></a></li> -->
            <li class="<?=isActive('qrcodes')?>"><a href="/wfba/qrcodes"><i class="fa fa-user"></i> <span>用户明细</span></a></li>
            <li class="<?=isActive('hb_check')?>"><a href="/wfba/hb_check"><i class="fa fa-user"></i> <span>红包发送审核</span> </a></li>
            <!--<li class="treeview <?=isActive(array('stats_totle', 'history_trades','history_withdrawals','stats_goods'))?>">
              ...
              <ul class="treeview-menu">
                <li class="<?=isActive('stats_totle')?>"><a href="/wfba/stats_totle"><i class="fa fa-circle-o"></i> <span>概况</span> </a></li>
            ...
            -->
            <?php if($_SESSION['wfba']['admin'] >= 1):?>
              <li class="<?=isActive('admin')?>"><a href="/wfba/logins"><i class="fa fa-user"></i> <span>账号管理</span></a></li>
            <?php endif?>
