...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="/rwba/items">账号管理</a></li>
      ...
      <div class="row">
        <div class="col-lg-5">
          <div class="form-group">
            ...
            <a href="/rwba/empty_ticket/<?=$bid?>"><button type="button" class="btn btn-warning">点击清空</button></a>
          </div>
        </div>
      </div>
      <?php endif?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="/rwba/items/edit/<?=$result['item']['id']?>?DELETE=1" class="btn btn-outline">确认删除</a>
      </div>
