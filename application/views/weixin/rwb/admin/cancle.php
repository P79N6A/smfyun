        ...
        <?php if ($result['ok8'] > 0):?>
          ...
          <form role="form" method="post">
            <div class="form-group">
              <label for="show" style="font-size:16px;">1、粉丝取消关注公众号后，该粉丝的首次关注奖励积分，该粉丝上线、上线的上线获得的积分奖励，全部扣除；该粉丝重新关注公众号后，积分不会再添加。<br>

2、用户点击菜单进入积分相关页面，会自动筛选下线、下线的下线是否有取消关注，有的话按照上述流程扣除积分；</label>
              <div class="radio">
