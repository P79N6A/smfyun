        ...
        <li>
            <div class="cd-single-item">
              <ul class="cd-slider-wrapper">
                ...
                <div style="display:inline-block" class="order-info">
                    <ul>
                    <li class="left2"><b>活动名称：</b><?=$prize->task_name?></li>
                    <li class="left" style="width:100%;"><b>奖品名称：</b><?=$prize->item_name?></li>
                    <li class="left" style="width:100%;"><b>领取状态：</b><?=$prize->state==1?'发送成功':'发送失败'?></li>
                    </ul>
                </div>
        </li>
<?php endforeach?>
