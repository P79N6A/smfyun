<html>
  <head>
    ...
    <meta name="keywords" content="预约宝">
    <meta name="description" content="预约宝是由武汉神马浮云开发的微信平台活动工具，是微信运营人员必备的吸粉神器。">
    <title><?=$title?></title>

    <link rel="stylesheet" type="text/css" href="http://cdn.jfb.smfyun.com/yyb/front/css/ui.css?v<?=date('Ymd')?>">
    <link rel="stylesheet" type="text/css" href="http://cdn.jfb.smfyun.com/yyb/front/css/style.css?v<?=date('Ymd')?>">
  <!-- Gem style -->
  </head>

  <script src="http://cdn.jfb.smfyun.com/yyb/plugins/jQuery/jQuery-2.1.4.min.js"></script>
    ...
    <div class="wrp">
      ...
      <div class="profile_fun">
            ...
            <ul id="js_menu" class="menu_list">
                <? if(Session::instance()->get('yyb')["bid"]==582):?>
                <li class="menu_item fans_record" style="width:50%">
                    <a href="/yyb/score" class="inner_item">
                ...
                <li class="menu_item rank_record" style="width:50%">
                    <a href="/yyb/top" class="inner_item">
                        <span class="icon_menu"></span>
              ...
              <? else:?>
                ...
                <li class="menu_item swap_record">
                    <a href="/yyb/items" class="inner_item">
                        <span class="icon_menu"></span>
