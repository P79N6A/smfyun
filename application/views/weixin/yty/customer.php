      ...
      <?//else:?>
        <a href="/yty/customer">
            <div class="ui border-bottom overview">
                <div class="item">
                    <div class="value ellipsis">
                        <span class="font-size-28 c-green"><?=(int)$user2['kehus']?></span>
                    </div>
...
<div id="rankpage">
    <section id="ranking">
        ...
        $count2 = $user->trades->select(array('SUM("money")', 'money1'))->where_open()->or_where('status', '=', 'WAIT_SELLER_SEND_GOODS')->or_where('status', '=', 'WAIT_BUYER_CONFIRM_GOODS')->or_where('status', '=', 'TRADE_BUYER_SIGNED')->where_close()->find()->money1;
        ?>
                <section class="box block-item">
