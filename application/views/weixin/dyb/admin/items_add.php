<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="/dyba/items">奖品管理</a></li>
    ...
    $('#rate').show();
      ...
      <div class="form-group">
        ...
        <?php if ($result['action'] == 'edit' && $result['item']['pic']):?>
          <div class="form-group"><img class="img-thumbnail" src="/dyba/images/item/<?=$result['item']['id']?>.v<?=$result['item']['lastupdate']?>.jpg" width="100"></div>
...
<div class="row" style="display:none" id="rate">
      ...
      <div id="tab-content" class="form-group" <?=($type==3) ? ' style="display:none;"' : ''?>>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="/dyba/items/edit/<?=$result['item']['id']?>?DELETE=1" class="btn btn-outline">确认删除</a>
      </div>
