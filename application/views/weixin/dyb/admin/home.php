        ...
        <div class="tab-content">
          ...
          <div class="tab-pane" id="cfg_yz">
            <div class="callout callout-success">
              ...
              <p><b>插件 token：</b> <u>dingyuebao</u></p>
              <p><b>插件 url：</b> <u><?='http://'.$_SERVER["HTTP_HOST"].'/api/dyb/'.$_SESSION['dyba']['user'];?></u></p>
              <p><a href="http://koudaitong.com/apps/third" target="_blank">点击这里</a> 进入有赞插件页面设置</p>
            </div>
             <form role="form" method="post">
              <div class="box-body">
                <?php if($oauth==1):?>
                  <p class="alert alert-danger alert-dismissable">注意：如果需要使用批量打标签、有赞积分同步功能，请务必点击有赞一键授权，否则以上功能将无法使用</p>
                <div class="lab4">
                  <a href='/dyba/oauth'><button type="button" class="btn btn-warning">点击一键授权有赞</button></a>
                </div>
                <br>
                <?else:?>
                <div class="lab4">
                  <a href='/dyba/oauth'><button type="button" class="btn btn-warning">点击重新授权有赞</button></a>
                </div>
                <?endif?>
              </div><!-- /.box-body -->
          ...
          <div class="tab-pane" id="cfg_text">
            ...
            <form role="form" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                if ($result['tpl']):
                  ?>
                <div class="form-group">
                  <a href="/dyba/images/cfg/<?=$result['tpl']?>.v<?=time()?>.jpg" target="_blank"><img class="img-thumbnail" src="/dyba/images/cfg/<?=$result['tpl']?>.v<?=time()?>.jpg" width="200" title="点击查看原图"></a>
                </div>
              <?php endif?>
              ...
              <div class="form-group">
                ...
                <p class="help-block">只能为 JPEG 格式，规格建议为 640*900px，最大不超过 300K，<a href="/dyb/tpl.zip" target="_blank">点击这里</a> 下载 PSD 模板自行设计。</p>
              </div>
              ...
              if ($result['tplhead']):
                ?>
              <div class="form-group">
                <a href="/dyba/images/cfg/<?=$result['tplhead']?>.v<?=time()?>.jpg" target="_blank"><img class="img-thumbnail" src="/dyba/images/cfg/<?=$result['tplhead']?>.v<?=time()?>.jpg" width="100" title="点击查看原图"></a>
              </div>
            <?php endif?>
            ...
            <div class="form-group">
              <label for="text_follow_url">引导用户快速关注的页面网址</label>
              <input type="text" class="form-control" id="subhref" name="text[subhref]" placeholder="http://" value="<?=$config['subhref']?>">
            </div>

            <div class="form-group">
              <label for="text_follow_url">活动说明网址</label>
            ...
            <?php if($bid==5):?>
              <div class="row">
                <div class="col-lg-4 col-sm-6">
                  <div class="form-group">
                    <label for="rank">支付多少可以生成海报 单位：分（0表示不限）</label>
                    <input type="number" class="form-control" id="rank" name="text[needpay]"  maxlength='2' value="<?=intval($config['needpay'])?>">
                  </div>
                </div>
              </div>
                  <div class="form-group">
            ...
            <div class="tab-pane" id="cfg_zero">
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          ...
                          <a href="<?php echo URL::site("dyba/empty")?>?DELETE=1" class="btn btn-outline">确认清空</a>
                        </div>
                      </div><!-- /.modal-content -->
                    </div><!-- /.modal-dialog -->
                  </div><!-- /.modal -->
              ...
              <div class="tab-pane" id="cfg_area">
                ...
                <!-- // <script src="/dyb/plugins/jQuery/jquery.js"></script> -->
                <script src="http://cdn.jfb.smfyun.com/dyb/plugins/citySelect/jquery.cityselect.js"></script>
                <script src="/dyb/plugins/citySelect/city.min1.js"></script>
                <script type="text/javascript">
                  $("#city1").citySelect({
                    prov:'',
                    city:'',
