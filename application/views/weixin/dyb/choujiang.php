    ...
    <div class="view js-page-view" id="page-view-detail">
        <div class="detail-header" id="detail-header">
                ...
                <div style="width: 320px;">
                 <img src="http://cdn.jfb.smfyun.com/dyb/images/item/<?=$thitem->id?>.v<?=$thitem->lastupdate?>0.jpg" alt="<?=$thitem->name?>">
...
<div id="pay-bar" class="pay-bar"> 单价：
   ...
   $('.pay-btn').click(function() {
            $.ajax({
              url: '/dyb/choujiang?choujiang=true&iid=<?=$thitem->id?>',
              type: 'get',
              dataType: 'json',
              timeout:15000,
        beforeSend:function(XMLHttpRequest){
              ...
              "<div class=\"mtk\">"+
                "<div class=\"mtkcont\">"+
                  ...
                  "<a href=\"/wdy/prize/<?=$thitem->id?>/1\"><input type=\"button\" class=\"queding ok2\" value=\"立即领奖\" id=\"one\" style=\"cursor:pointer\"></a>"+
                "</div>"+
              "</div>"
                      );
                    }else
