...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="/dkaa/qrcodes">订单记录</a></li>
        ...
        <div class="box box-success">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                //   $count3 = ORM::factory('dka_score')->where('bid', '=', $v->bid)->where('qid', '=', $v->id)->where('type', 'IN', array(3,8))->count_all();
                //   $fuser = ORM::factory('dka_qrcode')->where('bid', '=', $v->bid)->where('openid', '=', $v->fopenid)->find();
                  //$information=ORM::factory('dka_qrcode',array('id'=>$v->qid,'bid'=>$v->bid))->find();
                $information=ORM::factory('dka_qrcode')->where('id','=',$v->qid)->find();
                $fid = ORM::factory('dka_detail')->where('tid', '=', $v->id)->where('type', '=', 2)->find();
                $fuser = ORM::factory('dka_qrcode')->where('id', '=', $fid->qid)->find();
