...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="/dkaa/stats_goods">商品统计</a></li>
            ...
            <form method="post" method="post">
             <table class="table table-hover">
                <tbody>
                  <tr>
                    <th>商品名</th>
                    <th nowrap=""><a href="/dkaa/stats_goods?sort=toprice" title="按交额">有赞成交金额</a></th>
                    <th nowrap=""><a href="/dkaa/stats_goods?sort=totle" title="按订单数">有赞订单数</th>
                    <th nowrap=""><a href="/dkaa/stats_goods?sort=tonum" title="按销售数量">销售数量</th>
