...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/dka/dist/css/animate.min.css">
	<script type="text/javascript" src="/dka/dist/js/zepto.js"></script>
	...
	<!-- <script type="text/javascript" src="/dka/dist/js/global.js"></script> -->
	<script type="text/javascript">
	var _width=640;
var _height=1700;
...
$(function(){
					...
					success:function(res){
						...
						if(res[0] == false){
							...
							$(document).on('click','.knew',function(){
								$('.show').remove();
								window.location.href="/dka/score";
							});
						}else if(res[1] == false){
						...
						$(document).on('click','.get',function(){
							$('.show').remove();
							window.location.href="/dka/neworder/"+iid+"?rank="+ptype;
						});
						}else{
	...
	<script type="text/javascript" src="/dka/dist/js/jquery.min.js"></script>
	<script type="text/javascript" src="/dka/dist/js/jQueryRotate.2.2.js"></script>
	<script type="text/javascript" src="/dka/dist/js/jquery.easing.min.js"></script>
	<style>
		*,body{
			margin:0;
			padding:0;
		...
		.container{
			width:100%;
			height:auto;
			background-image: url('/dka/dist/img/choujiang/bg.png');
		...
		.stage{
			...
			margin:0 auto;
			overflow: hidden;
			background-image: url("/dka/dist/img/choujiang/zhuangpan.png");
			background-repeat:no-repeat;
			background-size: 100%;
		}
		.zhizhen{
...
<body>
	<div class="container">
		<div class="top_word">
			<img src="/dka/dist/img/choujiang/round3.png"/>
		</div>
		<div class="stage">
			<div class="zhizhen"><img class="rotate_button" src="/dka/dist/img/choujiang/button.png"></div>
		</div>
		<div class="huodong">
			<div class="huodong_top">
			<img src="/dka/dist/img/choujiang/rule_top.png">
			<img class="arrow arrow_top" src="/dka/dist/img/choujiang/arrow.png">
			<img class="arrow arrow_bottom" src="/dka/dist/img/choujiang/arrow_bottom.png">
			</div>
