...
<html>
  <head>
    ...
    <link rel="stylesheet" href="/dka/dist/css/skins/skin-green.min.css">
  </head>

  <script src="/dka/plugins/jQuery/jQuery-2.1.4.min.js"></script>
  ...
  <body class="hold-transition skin-green sidebar-mini">
    ...
    <script src="/dka/bootstrap/js/bootstrap.min.js"></script>
    <script src="/dka/dist/js/app.min.js"></script>

    <script type="text/javascript" src="/dka/plugins/simditor-2.2.4/scripts/module.js"></script>
    <script type="text/javascript" src="/dka/plugins/simditor-2.2.4/scripts/hotkeys.js"></script>
    <script type="text/javascript" src="/dka/plugins/simditor-2.2.4/scripts/simditor.js"></script>

    <script type="text/javascript" src="/dka/plugins/datetimepicker/js/bootstrap-datetimepicker.js"></script>
    <script type="text/javascript" src="/dka/plugins/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js"></script>

    <script src="/dka/plugins/slimScroll/jquery.slimscroll.min.js"></script>
    <script src="/dka/plugins/fastclick/fastclick.min.js"></script>
