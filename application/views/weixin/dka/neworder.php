        ...
        <li>
            <div class="cd-single-item">
                <ul class="cd-slider-wrapper">
                    <li class="selected"><img src="<?=$config['cdn']?>/dka/images/item/<?=$item->id?>.v<?=$item->lastupdate?>.jpg" alt="<?=$item->name?>"></li>
                </ul>
            </div> <!-- .cd-single-item -->
            <div class="cd-item-info">
                <b><a href="/dka/neworder/<?=$item->id?>"><?=$item->name?></a></b>
...
<script src="http://cdn.jfb.smfyun.com/dka/plugins/citySelect/jquery.cityselect.js"></script>
