            ...
            <form role="form" method="post" enctype='multipart/form-data'>
              <div class="box-body">
                ...
                <?php if($user->refresh_token):?>
                  <a href='https://mp.weixin.qq.com/cgi-bin/componentloginpage?component_appid=wx47384b8b7a68241e&pre_auth_code=<?=$pre_auth_code?>&redirect_uri=http://<?=$_SERVER["HTTP_HOST"]?>/wxpa/home'><button type="button" class="btn btn-warning">点击重新授权</button></a>
                <?php else:?>
                  <a href='https://mp.weixin.qq.com/cgi-bin/componentloginpage?component_appid=wx47384b8b7a68241e&pre_auth_code=<?=$pre_auth_code?>&redirect_uri=http://<?=$_SERVER["HTTP_HOST"]?>/wxpa/home'><button type="button" class="btn btn-warning">点击一键授权</button></a>
                <?php endif?>
                </div>
                <div class="form-group">
          ...
          <div class="tab-pane" id="cfg_order">
            <?php if ($success['ok']!=null):?>
                        ...
                        <?php else:?>
                            ...
                            <?php endif;?>
                            <p><a class="btn btn-success" href="<?php echo URL::site('wxpa/download/'.$buy_id)?>">下载红包素材</a></p>
            <?php endif;?>
