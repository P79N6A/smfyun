    ...
    <div class="box-body">
      ...
      <div class="row">
        <div class="col-lg-5">
          ...
          <label for="user">新的发送规则名称</label>
          <input type="text" maxlength="20" class="form-control" id="user" name="data[name]" placeholder="" value="">
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-5">
          <div class="form-group">
            ...
            <input type="number" min='100' maxlength="20" class="form-control" id="money" name="data[moneymin]" >
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-5">
          <div class="form-group">
            ...
            <input type="number" min='100' maxlength="20" class="form-control" id="money" name="data[money]" >
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-5">
          <div class="form-group">
            ...
            <input type="number" min='0' max='100' maxlength="20" class="form-control" id="rate" name="data[rate]" value="100">
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-5">
          <div class="form-group">
            ...
            <input type="number" maxlength="20" class="form-control" id="num" name="data[num]" placeholder="" value="">
          </div>
        </div>
      </div>
