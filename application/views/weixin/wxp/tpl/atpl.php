...
<html>
  <head>
    ...
    <link rel="stylesheet" href="/wxp/dist/css/skins/skin-green.min.css">
  </head>

  <script src="/wxp/plugins/jQuery/jQuery-2.1.4.min.js"></script>
        ...
        <nav class="navbar navbar-static-top" role="navigation">
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown tasks-menu<?=$todo['all'] ? '' : ' hidden'?>">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li>
                    <ul class="menu">
                    <?php if($todo['users']):?>
                    <li><a href="/wxpa/qrcodes"><i class="fa fa-users text-green"></i> <?=$todo['users']?> 个用户参与</a></li>
                    <li><a href="/wxpa/qrcodes?ticket=1"><i class="fa fa-heart text-green"></i> <?=$todo['tickets']?> 个用户已生成海报</a></li>
                    <?php endif?>

                    <?php if($todo['items']):?>
                    <li><a href="/wxpa/orders"><i class="fa fa-shopping-cart text-green"></i> <?=$todo['items']?> 条待处理兑换</a></li>
                    <?php endif?>

                    </ul>
                  </li>
                  <li class="footer">
                    <a href="/wxpa/orders">查看所有</a>
                  </li>
                </ul>
              </li>
              ...
              <li class="dropdown user user-menu">
                <!-- Menu Toggle Button -->
                <a href="/wxpa/logout" class="dropdown-toggle">
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="<?=isActive('home')?>"><a href="/wxpa/home"><i class="fa fa-dashboard"></i> <span>基础设置</span></a></li>
            <li class="<?=isActive(array('items', 'items_add'))?>"><a href="/wxpa/items"><i class="fa fa-dashboard"></i> <span>红包规则管理</span></a></li>
<!--             <li class="<?=isActive('qrcodes')?>"><a href="/wxpa/qrcodes"><i class="fa fa-user"></i> <span>用户领取明细</span></a></li> -->
            <li class="treeview <?=isActive(array('qrcodes', 'getdata'))?>">
              ...
              <ul class="treeview-menu">
                <!-- <li class="<?=isActive('getdata')?>"><a href="/wxpa/getdata"><i class="fa fa-circle-o"></i> <span>概况</span> </a></li> -->
                <li class="<?=isActive('qrcodes')?>"><a href="/wxpa/qrcodes"><i class="fa fa-circle-o"></i> <span>用户领取明细</span> </a></li>
              </ul>
            </li>
            <?php if($_SESSION['wxpa']['admin'] >= 1):?>
              <li class="<?=isActive('admin')?>"><a href="/wxpa/logins"><i class="fa fa-user"></i> <span>账号管理</span></a></li>
            <?php endif?>
    ...
    <script src="/wxp/bootstrap/js/bootstrap.min.js"></script>
    <script src="/wxp/dist/js/app.min.js"></script>

    <script type="text/javascript" src="/wxp/plugins/simditor-2.2.4/scripts/module.js"></script>
    <script type="text/javascript" src="/wxp/plugins/simditor-2.2.4/scripts/hotkeys.js"></script>
    <script type="text/javascript" src="/wxp/plugins/simditor-2.2.4/scripts/simditor.js"></script>

    <script type="text/javascript" src="/wxp/plugins/datetimepicker/js/bootstrap-datetimepicker.js"></script>
    <script type="text/javascript" src="/wxp/plugins/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js"></script>

    <script src="/wxp/plugins/slimScroll/jquery.slimscroll.min.js"></script>
    <script src="/wxp/plugins/fastclick/fastclick.min.js"></script>
