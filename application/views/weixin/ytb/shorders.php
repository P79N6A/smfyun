        ...
        <li>
            <div class="cd-single-item">
                <ul class="cd-slider-wrapper">
                    <li class="selected"><img src="http://<?=$_SERVER['HTTP_HOST']?>/ytb/images/item/<?=$order->item->id?>.v<?=$order->item->lastupdate?>.jpg" alt="<?=$order->item->name?>"></li>
                </ul>
            </div> <!-- .cd-single-item -->
