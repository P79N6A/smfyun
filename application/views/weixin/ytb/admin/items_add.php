<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="/ytba/items">奖品管理</a></li>
...
<!--           <label class="checkbox-inline">
          ...
          <label class="checkbox-inline">
            ...
            <span class="label label-success" style="font-size:14px">有赞优惠劵</span>
          </label>
          <label class="checkbox-inline">
      ...
      <!-- 修改完 -->
      <div class="form-group">
      <label for="name">请选择奖品权限（为空默认所有等级均可兑换）</label>
        <div>
          <label class="checkbox-inline">
            <input type="checkbox" name='auth[1]' id="inlineCheckbox2" value="b" <?=strpos($auth, "b")===false?'':'checked'?>>
            <span class="label label-success" style="font-size:14px"><?=$config['third']?></span>
          </label>
          <label class="checkbox-inline">
            <input type="checkbox" name='auth[2]' id="inlineCheckbox3" value="c" <?=strpos($auth, "c")===false?'':'checked'?>>
            <span class="label label-success" style="font-size:14px"><?=$config['second']?></span>
          </label>
          <label class="checkbox-inline">
            <input type="checkbox" name='auth[3]' id="inlineCheckbox4" value="d" <?=strpos($auth, "d")===false?'':'checked'?>>
            <span class="label label-success" style="font-size:14px"><?=$config['first']?></span>
          </label>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <?php if ($result['action'] == 'edit' && $result['item']['pic']):?>
          <div class="form-group"><img class="img-thumbnail" src="/ytba/images/item/<?=$result['item']['id']?>.v<?=$result['item']['lastupdate']?>.jpg" width="100"></div>
...
4、请商户按照上述要求操作，因为运营操作不当、兑换门槛过低导致的损失，与我方无关；</label>
      ...
      <div id="tab-content" class="form-group" <?=($type==3||$type==5) ? ' style="display:none;"' : ''?>>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="/ytba/items/edit/<?=$result['item']['id']?>?DELETE=1" class="btn btn-outline">确认删除</a>
      </div>
