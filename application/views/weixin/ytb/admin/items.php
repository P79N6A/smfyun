...
<section class="content">
  ...
  <div class="row">
    <div class="col-xs-12">
      <a href="/ytba/items/add" class="btn btn-success pull-right" style="margin-right:10px;margin-bottom:10px"> <i class="fa fa-plus"></i> &nbsp; <span>添加新奖品</span></a>
    </div>
  </div>
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <tr>
                  ...
                  <td><a href="/ytba/items/edit/<?=$item->id?>"><span>修改</span> <i class="fa fa-edit"></i></a></td>
                </tr>
