...
<section>
    ...
    <div class="main-content" >
        ...
        <section style="float:left;width:12%;height:100%;background:#2E3A4E;position:fixed;overflow:none">
            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
        <li><a href="/qwtwfba/home"><i class="fa fa-sign-in"></i> <span>基础设置</span></a></li>
         <li class="menu-list <?=isActive(array('orders', 'items'))?>"><a href=""><i class="fa fa-bullhorn"></i> <span>奖品设置</span></a>
        <ul class="sub-menu-list">
                <li class="<?=isActive('orders')?>"><a href="/qwtwfba/orders">兑换记录</a></li>
                <li class="<?=isActive('items')?>"><a href="/qwtwfba/items">奖品管理</a></li>
            </ul>
        </li>
         <li><a href="/qwtwfba/stats_totle"><i class="fa fa-sign-in"></i> <span>数据统计</span></a></li>
        <li><a href="/qwtwfba/qrcodes"><i class="fa fa-sign-in"></i> <span>用户明细</span></a></li>
         <li class="menu-list <?=isActive(array('zero', 'area'))?>"><a href=""><i class="fa fa-bullhorn"></i> <span>可选功能</span></a>
        <ul class="sub-menu-list">
                <li class="<?=isActive('zero')?>"><a href="/qwtwfba/zero">积分清零</a></li>
                <li class="<?=isActive('area')?>"><a href="/qwtwfba/area">选择可参与地区</a></li>
            </ul>
        </li>
    </ul>
        </section>
