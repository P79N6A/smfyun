...
<section>
    ...
    <div class="main-content" >
        ...
        <li><a href="home"><i class="fa fa-sign-in"></i> <span>基础设置</span></a></li>
         <li class="menu-list <?=isActive(array('getdata', 'qrcodes'))?>"><a href=""><i class="fa fa-bullhorn"></i> <span>数据统计</span></a>
        <ul class="sub-menu-list">
                <li class="<?=isActive('getdata')?>"><a href="getdata">概况</a></li>
                <li class="<?=isActive('qrcodes')?>"><a href="qrcodes">用户领取明细</a></li>
            </ul>
        </li>
       </ul>
        </section>
