      ...
      <div class="nav-tabs-custom" style="background:white">
          ...
          <form method="get" name="ordersform">
            <ul class="nav nav-tabs custom-tab dark-tab">
              <li id="orders<?=$status?>" class="<?=$status== 1 ? 'active' : ''?>"><a href="/qwtrwba/stats_totle?qid=1">按天统计</a></li>
              <li id="orders<?=$status?>" class="<?=$status == 2? 'active' : ''?>"><a href="/qwtrwba/stats_totle/month?qid=2">按月统计</a></li>
              <li id="orders<?=$status?>" class="<?=$status == 3? 'active' : ''?>"><a href="/qwtrwba/stats_totle/shaixuan?qid=3">按日期筛选</a></li>
              <!-- <div> -->
