      ...
      <section class="panel">
        ...
        <div class="panel-body">
            ...
            <form role="form" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                if ($result['tpl']):
                  ?>
                <div class="form-group">
                  <a href="/qwtwdba/images/cfg/<?=$result['tpl']?>.v<?=time()?>.jpg" target="_blank"><img class="img-thumbnail" src="/qwtwdba/images/cfg/<?=$result['tpl']?>.v<?=time()?>.jpg" width="200" title="点击查看原图"></a>
                </div>
              <?php endif?>
              ...
              <div class="form-group">
                ...
                <p class="help-block">只能为 JPEG 格式，规格建议为 640*900px，最大不超过 300K，<a href="/qwtwdb/tpl.zip" target="_blank">点击这里</a> 下载 PSD 模板自行设计。</p>
              </div>
              ...
              if ($result['tplhead']):
                ?>
              <div class="form-group">
                <a href="/qwtwdba/images/cfg/<?=$result['tplhead']?>.v<?=time()?>.jpg" target="_blank"><img class="img-thumbnail" src="/qwtwdba/images/cfg/<?=$result['tplhead']?>.v<?=time()?>.jpg" width="100" title="点击查看原图"></a>
              </div>
            <?php endif?>
            ...
            <div class="form-group">
              ...
              <p class="help-block">建议设置为活动说明的页面，示例网址：<a href="http://kdt.im/znDoi9NAE" target="_blank">http://kdt.im/znDoi9NAE</a></p>
            </div>
