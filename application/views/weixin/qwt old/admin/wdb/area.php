        ...
        <div class="tab-content">
              ...
              <div class="tab-pane" id="cfg_area">
                ...
                <form role="form" method="post" onsubmit="return toVaild()">
                  <div class="form-group">
                    ...
                    <div style="margin-left:-20px">
                      ...
                      <label class="checkbox-inline" onclick="hide()">
                        <input class="guanbi" type="radio" name="area[status]" id="show0" value="0" <?=$config['status'] === "0" ||!$config['status']? ' checked=""' : ''?>>
                  ...
                  <br><br>
                  <div class="form-group">
                    <label for="desc">对不符合活动地区的用户提示文案</label><br>
                 ...
                 <div class="form-group">
                    ...
                    <textarea class="textarea" id="info" name="data[info]" placeholder="" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php if($config['info']){echo $config['info'];}else{echo '
                      1 、本次活动可参与的地区范围：<br>
                      2 、活动时间：<br>
                      3 、活动注意事项：';}?></textarea>
                  </div>
