...
<section class="wrapper" style="width:85%;float:right;background:#fffff">
...
?>
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="/qwtwfba/stats_totle">概况</a></li>
      ...
      <div class="nav-tabs-custom" style="background:white">
          ...
          <form method="get" name="ordersform">
            <ul class="nav nav-tabs custom-tab dark-tab">
              <li id="orders<?=$status?>" class="<?=$status== 1 ? 'active' : ''?>"><a href="/qwtwfba/stats_totle?qid=1">按天统计</a></li>
              <li id="orders<?=$status?>" class="<?=$status == 2? 'active' : ''?>"><a href="/qwtwfba/stats_totle/month?qid=2">按月统计</a></li>
              <li id="orders<?=$status?>" class="<?=$status == 3? 'active' : ''?>"><a href="/qwtwfba/stats_totle/shaixuan?qid=3">按日期筛选</a></li>
              <!-- <div> -->
             ...
             <table class="table table-hover">
              <? if($status == 3):?>
                <div class="input-group" style="width: 300px;display: flex;">
                 <input name="data[begin]" value="<?=$_GET['data']['begin']?>" readonly="" class="form_datetime form-control pull-right" type="text">
                 <input name="data[over]"  value="<?=$_POST['data']['over']?>" readonly="" class="form_datetime form-control pull-right" type="text">
                 <div class="input-group-btn add88">
                    <button id="ssbtn" class="btn btn-sm btn-default" type="submit"><i class="fa fa-search"></i></button>
                 </div>
                </div>
