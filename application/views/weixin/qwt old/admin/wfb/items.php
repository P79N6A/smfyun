    ...
    <li class="active">奖品管理</li>
                ...
                <header class="panel-heading">
                    ...
                    <span class="tools pull-right">
                        <a href="/qwtwfba/items/add" class="btn btn-success pull-right" style="margin-right:10px;margin-bottom:10px;height:40px"> <i class="fa fa-plus"></i> &nbsp; <span>添加新奖品</span></a>
                     </span>
                </header>
                ...
                <tr>
                  ...
                  <td><a href="/qwtwfba/items/edit/<?=$item->id?>"><span>修改</span> <i class="fa fa-edit"></i></a></td>
                </tr>
