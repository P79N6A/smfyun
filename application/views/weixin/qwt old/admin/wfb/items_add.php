...
<script src="http://cdn.bootcss.com/jquery/2.0.1/jquery.js"></script>
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="/qwtwfba/items">奖品管理</a></li>
    ...
    <div class="box-body">
      ...
      <div class="form-group">
        ...
        <div style="margin-left:-20px" id="myTab">
         <label class="checkbox-inline">
            <input id='true' type="radio" name="data[type]" value="0" onclick="change(0)"<?=$type==0 ? ' checked="checked"' : ''?>>
      ...
      <div class="form-group">
        ...
        <?php if ($result['action'] == 'edit' && $result['item']['pic']):?>
          <div class="form-group"><img class="img-thumbnail" src="/qwtwfba/images/item/<?=$result['item']['id']?>.v<?=$result['item']['lastupdate']?>.jpg" width="100"></div>
...
4、请商户按照上述要求操作，因为运营操作不当、兑换门槛过低导致的损失，与我方无关；</label>
      ...
      <div class="row">
       ...
       <div id="tab-content" class="form-group" <?=($type==0||$type==3||$type==4) ? ' style="display:none;"' : ''?>>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="/qwtwfba/items/edit/<?=$result['item']['id']?>?DELETE=1" class="btn btn-outline">确认删除</a>
      </div>
