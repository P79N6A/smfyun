...
<form method="get" name="loginsform">
  ...
  <div class="row">
    <div class="col-xs-12">
      <a href="/dgba/logins/add" class="btn btn-success pull-right" style="margin-right:10px;margin-bottom:10px"> <i class="fa fa-plus"></i> &nbsp; <span>添加新用户</span></a>
    </div>
  </div>
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <tr>
                  ...
                  <td><a href="/dgba/logins/edit/<?=$login->id?>"><span>修改</span> <i class="fa fa-edit"></i></a></td>
                </tr>
