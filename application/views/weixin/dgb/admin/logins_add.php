...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="/dgba/items">账号管理</a></li>
  ...
  <form role="form" method="post" enctype="multipart/form-data">
    <div class="box-body">
      ...
      <div class="row">
        <div class="col-lg-5">
          <div class="form-group">
            <label for="name">商户备注</label>
            <input type="text" maxlength="20" class="form-control" id="name" name="data[name]" placeholder="商户备注" value="<?=trim($_POST['data']['name'])?>">
          </div>
        </div>
      </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="/dgba/items/edit/<?=$result['item']['id']?>?DELETE=1" class="btn btn-outline">确认删除</a>
      </div>
