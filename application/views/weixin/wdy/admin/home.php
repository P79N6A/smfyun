        ...
        <div class="tab-content">
          ...
          <div class="tab-pane" id="cfg_yz">
            ...
            <div class="callout callout-success">
              ...
              <p><b>插件 url：</b> <u><?='http://'.$_SERVER["HTTP_HOST"].'/api/wdy/'.$_SESSION['wdya']['user'];?></u></p>
            ...
            <form role="form" method="post">
              <div class="box-body">
                ...
                <?php if($oauth==1):?>
                  <div class="lab4">
                    <a href='/wdya/oauth'><button type="button" class="btn btn-warning">点击一键授权有赞</button></a>
                  </div>
                  <br>
                  <?else:?>
                  <div class="lab4">
                    <a href='/wdya/oauth'><button type="button" class="btn btn-warning">点击重新授权有赞</button></a>
                  </div>
                  <?endif?>
                <!-- <div class="lab4">
          ...
          <div class="tab-pane" id="cfg_text">
            ...
            <form role="form" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                if ($result['tpl']):
                  ?>
                <div class="form-group">
                  <a href="/wdya/images/cfg/<?=$result['tpl']?>.v<?=time()?>.jpg" target="_blank"><img class="img-thumbnail" src="/wdya/images/cfg/<?=$result['tpl']?>.v<?=time()?>.jpg" width="200" title="点击查看原图"></a>
                </div>
              <?php endif?>
              ...
              if ($result['tplhead']):
                ?>
              <div class="form-group">
                <a href="/wdya/images/cfg/<?=$result['tplhead']?>.v<?=time()?>.jpg" target="_blank"><img class="img-thumbnail" src="/wdya/images/cfg/<?=$result['tplhead']?>.v<?=time()?>.jpg" width="100" title="点击查看原图"></a>
              </div>
            <?php endif?>
            ...
            <div class="tab-pane" id="cfg_zero">
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          ...
                          <a href="<?php echo URL::site("wdya/empty")?>?DELETE=1" class="btn btn-outline">确认清空</a>
                        </div>
                      </div><!-- /.modal-content -->
                    </div><!-- /.modal-dialog -->
                  </div><!-- /.modal -->
              ...
              <div class="tab-pane" id="cfg_area">
                ...
                <!-- // <script src="/wdy/plugins/jQuery/jquery.js"></script> -->
