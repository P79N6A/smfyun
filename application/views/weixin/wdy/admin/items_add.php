<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="/wdya/items">奖品管理</a></li>
    ...
    $('#rate').show();
      ...
      <div class="form-group">
        ...
        <?php if ($result['action'] == 'edit' && $result['item']['pic']):?>
          <div class="form-group"><img class="img-thumbnail" src="/wdya/images/item/<?=$result['item']['id']?>.v<?=$result['item']['lastupdate']?>.jpg" width="100"></div>
...
4、请商户按照上述要求操作，因为运营操作不当、兑换门槛过低导致的损失，与我方无关；</label>
     ...
     <select name="yzgift"  <?=($type==6)?'':'style="display:none"'?> class="form-control yzgift" >
      ...
      <!--有赞赠品-->
      <!--微信红包-->
      <div id="hongbao-content" class="form-group" <?=($type==1||$type==2||$type==3||$type==4||$type==6||$type==7) ? ' style="display:none;"' : ''?>>
        <div class="tab-content" >
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="/wdya/items/edit/<?=$result['item']['id']?>?DELETE=1" class="btn btn-outline">确认删除</a>
      </div>
