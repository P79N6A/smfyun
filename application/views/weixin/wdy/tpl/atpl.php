  ...
  <body class="hold-transition skin-green sidebar-mini">
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <!-- Logo -->
        <a href="/wdya/home" class="logo">
          <span class="logo-mini"><b>粉</b></span>
          <span class="logo-lg"><i class="fa fa-wechat"></i>&nbsp;<b>积分宝</b></span>
        </a>

        <!-- Header Navbar -->
        <nav class="navbar navbar-static-top" role="navigation"><div style="font-size: 14px;margin-top: 13px;color: #fff;position: absolute;left: 50px; "><!-- 公告：为配合微信接口政策的调整，请<a target="_blank" style="color: #00c0ef;font-weight: bold;" href='https://h5.youzan.com/v2/feature/pbz2iy7e'>点击这里</a>查看教程，尽快开启IP白名单，以保证系统的正常使用。<br> -->为配合有赞云的接口升级，请在积分宝-基础设置-绑定有赞，点击重新授权有赞，以保证正常使用。</div><!-- <div style="font-size: 16px;margin-top: 13px;color: #fff;position: absolute;left: 50px; ">公告：为配合有赞云的接口升级，保证有赞赠品功能的正常使用，请在基础设置-绑定有赞，点击“重新绑定有赞”</div> -->
          ...
          <? else:?>
          <span style='display:inline-block;padding-top:15px;color:#f6f6f6;'><a href="http://shop1128733.koudaitong.com/v2/feature/nbo89d92" style="color:white;" target="_blank"> 点击这里查看积分宝系统使用说明书</a></span>
          <? endif;?>
          <!-- Navbar Right Menu -->
              ...
              <li class="dropdown tasks-menu<?=$todo['all'] ? '' : ' hidden'?>">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li>
                    <ul class="menu">
                    <?php if($todo['users']):?>
                    <li><a href="/wdya/qrcodes"><i class="fa fa-users text-green"></i> <?=$todo['users']?> 个用户参与</a></li>
                    <li><a href="/wdya/qrcodes?ticket=1"><i class="fa fa-heart text-green"></i> <?=$todo['tickets']?> 个用户已生成海报</a></li>
                    <?php endif?>

                    <?php if($todo['items']):?>
                    <li><a href="/wdya/orders"><i class="fa fa-shopping-cart text-green"></i> <?=$todo['items']?> 条待处理兑换</a></li>
                    <?php endif?>

                    </ul>
                  </li>
                  <li class="footer">
                    <a href="/wdya/orders">查看所有</a>
                  </li>
                </ul>
              </li>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="<?=isActive('home')?>"><a href="/wdya/home"><i class="fa fa-dashboard"></i> <span>基础设置</span></a></li>
            ...
            <li class="treeview <?=isActive(array('items', 'orders','create'))?>">
              ...
              <ul class="treeview-menu">
                <li class="<?=isActive('orders')?>"><a href="/wdya/orders"><i class="fa fa-circle-o"></i> <span>兑换记录</span> </a></li>
                <li class="<?=isActive('items')?>"><a href="/wdya/items"><i class="fa fa-circle-o"></i> <span>奖品管理</span> </a></li>
              </ul>
            </li>

            <li class="<?=isActive('stats_totle')?>"><a href="/wdya/stats_totle"><i class="fa fa-bar-chart"></i> <span>数据统计</span> </a></li>

            <!-- <li class="<?=isActive('stats')?>"><a href="/wdya/stats"><i class="fa fa-bar-chart"></i> <span>活动统计</span></a></li> -->
            <li class="<?=isActive('qrcodes')?>"><a href="/wdya/qrcodes"><i class="fa fa-user"></i> <span>用户明细</span></a></li>
            <li class="treeview <?=isActive(array('zero', 'lab','area','rsync','cancle','hb_check'))?>">
              ...
              <ul class="treeview-menu">
                <li class="<?=isActive('zero')?>"><a href="/wdya/zero"><i class="fa fa-circle-o"></i> <span>积分清零</span> </a></li>
                ...
                <li class="<?=isActive('rsync')?>"><a href="/wdya/rsync"><i class="fa fa-circle-o"></i> <span>有赞积分同步</span> </a></li>
                <li class="<?=isActive('cancle')?>"><a href="/wdya/cancle"><i class="fa fa-circle-o"></i> <span>取消关注后扣积分</span> </a></li>
                <li class="<?=isActive('hb_check')?>"><a href="/wdya/hb_check"><i class="fa fa-circle-o"></i> <span>红包发送审核</span> </a></li>
              </ul>
            </li>
            ...
            <!--<li class="treeview <?=isActive(array('stats_totle', 'history_trades','history_withdrawals','stats_goods'))?>">
              ...
              <ul class="treeview-menu">
                <li class="<?=isActive('stats_totle')?>"><a href="/wdya/stats_totle"><i class="fa fa-circle-o"></i> <span>概况</span> </a></li>
            ...
            -->
            <?php if($_SESSION['wdya']['admin'] >= 1):?>
              <li class="<?=isActive('admin')?>"><a href="/wdya/logins"><i class="fa fa-user"></i> <span>账号管理</span></a></li>
            <?php endif?>
