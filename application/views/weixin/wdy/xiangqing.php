  ...
  <body class="page-detail" data-page="detail" ontouchstart="">
    <div class="view js-page-view" id="page-view-detail">
        <div class="detail-header" id="detail-header">
              ...
              <div style="width: 320px;"> <img src="http://cdn.jfb.smfyun.com/wdy/images/item/<?=$xqitem->id?>.v<?=$xqitem->lastupdate?>0.jpg" alt="<?=$xqitem->name?>">
           ...
           <?php if ($dlimit==1):?>
                ...
                <?php else:?>
                <a href="/wdy/neworder/<?=$xqitem->id?>" class="pay-btn">立即兑换</a>
                <?php endif?>
