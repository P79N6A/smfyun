...
<section class="content">
  <div class="row">
    ...
    <!-- <div class="row"> -->
        <!-- <div class="col-xs-12"> -->
          <a href="/kmia/items?value1=<?=$prize['value']?>&export=csv" class="btn btn-success pull-right" style="margin-right:50px;margin-bottom:10px;margin-top: 2%;"> <i class="fa fa-plus"></i> &nbsp; <span>导出卡密发送记录</span></a>
        <!-- </div> -->
    <!-- </div> -->
  <?php endif?>
