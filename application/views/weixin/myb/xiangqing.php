  ...
  <body class="page-detail" data-page="detail" ontouchstart="">
    <div class="view js-page-view" id="page-view-detail">
        <div class="detail-header" id="detail-header">
              ...
              <div style="width: auto;"> <img src="http://<?=$_SERVER['HTTP_HOST']?>/fxb/images/item/<?=$item->id?>.v<?=$item->lastupdate?>0.jpg" alt="<?=$item->name?>">
           ...
           <div id="pay-bar" class="pay-bar"> 单价：
            <span class="pay-total js-total-price">
             <b class="coins"><?=$item->score?></b><?=$config['scorename']?>
           </span>
           <?php if ($dlimit==1):?>
                ...
                <?php elseif ($user2['shscore'] < $item->score):?>
                    <a href="javascript:;" class="pay-btn js-pay disabled">您的<?=$config['scorename']?>不够</a>
                ...
                <?php else:?>
                <a href="/fxb/neworder/<?=$item->id?>" class="pay-btn">立即兑换</a>
                <?php endif?>
