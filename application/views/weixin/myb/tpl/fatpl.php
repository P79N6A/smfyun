...
<html>
  <head>
    ...
    <title><?=$title?> | <?=$config['name']?> | 美业宝</title>
  ...
  <body class="hold-transition skin-red sidebar-mini">
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <!-- Logo -->
        <a href="/myba/home" class="logo">
          <span class="logo-mini"><b>单</b></span>
          <span class="logo-lg"><i class="fa fa-wechat"></i>&nbsp;<b>有赞美业</b></span>
        </a>
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown tasks-menu<?=$todo['all'] ? '' : ' hidden'?>">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li>
                    <ul class="menu">
                    <?php if($todo['users']):?>
                    <li><a href="/myba/qrcodes"><i class="fa fa-users text-green"></i> <?=$todo['users']?> 个用户参与</a></li>
                    <li><a href="/myba/qrcodes?ticket=1"><i class="fa fa-heart text-green"></i> <?=$todo['tickets']?> 个用户已生成海报</a></li>
                    <?php endif?>

                    <?php if($todo['items']):?>
                    <li><a href="/myba/orders"><i class="fa fa-shopping-cart text-green"></i> <?=$todo['items']?> 条待处理兑换</a></li>
                    <?php endif?>

                    </ul>
                  </li>
                  <!-- <li class="footer">
                    <a href="/myba/orders">查看所有</a>
                  </li> -->
                </ul>
              </li>
              ...
              <li class="dropdown user user-menu">
                <!-- Menu Toggle Button -->
                <a href="/myba/logout" class="dropdown-toggle">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview <?=isActive(array('items', 'orders'))?>">
              ...
              <ul class="treeview-menu">
                <li class="<?=isActive('orders')?>"><a href="/myba/orders"><i class="fa fa-circle-o"></i> <span>兑换记录</span> </a></li>
                <li class="<?=isActive('items')?>"><a href="/myba/items"><i class="fa fa-circle-o"></i> <span>奖品管理</span> </a></li>
              </ul>
            </li>
            -->

            <!-- <li class="<?=isActive('stats')?>"><a href="/myba/stats"><i class="fa fa-bar-chart"></i> <span>活动统计</span></a></li> -->
            <li class="treeview">
            ...
            <li class="<?=isActive('home')?>"><a href="/myba/home"><i class="fa fa-dashboard"></i> <span>基础设置</span></a></li>

            <li class="<?=isActive('setgoods')?>"><a href="/myba/setgoods"><i class="fa fa-dashboard"></i> <span>分销商品管理</span></a></li>
            ...
            <li class="treeview <?=isActive(array('items', 'shorders'))?>">
              ...
              <ul class="treeview-menu">
                <li class="<?=isActive('items')?>"><a href="/myba/items"><i class="fa fa-circle-o"></i> <span>奖品设置</span> </a></li>
                <li class="<?=isActive('shorders')?>"><a href="/myba/shorders"><i class="fa fa-circle-o"></i> <span>兑换记录</span> </a></li>
              </ul>
            </li>
            <li class="<?=isActive('qrcodes')?>"><a href="/myba/qrcodes"><i class="fa fa-user"></i> <span>用户明细</span></a></li>
             <li class="treeview <?=isActive(array('stats_totle', 'history_trades','history_withdrawals','stats_goods'))?>">
              ...
              <ul class="treeview-menu">
                <li class="<?=isActive('stats_totle')?>"><a href="/myba/stats_totle"><i class="fa fa-circle-o"></i> <span>概况</span> </a></li>
                <li class="<?=isActive('history_trades')?>"><a href="/myba/history_trades"><i class="fa fa-circle-o"></i> <span>订单记录</span> </a></li>
                <!-- <li class="<?=isActive('history_withdrawals')?>"><a href="/myba/history_withdrawals"><i class="fa fa-circle-o"></i> <span>提现记录</span> </a></li> -->
                <li class="<?=isActive('stats_goods')?>"><a href="/myba/stats_goods"><i class="fa fa-circle-o"></i> <span>商品统计</span> </a></li>
              </ul>
            </li>
            <li class="treeview <?=isActive(array('calculate','history_scores'))?>">
            <a href="#"><i class="fa fa-calculator"></i> <span>结算管理</span> <i class="fa fa-angle-left pull-right"></i></a>
            <ul class="treeview-menu">
              <li class="<?=isActive('calculate')?>"><a href="/myba/calculate"><i class="fa fa-circle-o"></i> <span>结算账单</span> </a></li>
              <li class="<?=isActive('history_scores')?>"><a href="/myba/history_scores"><i class="fa fa-circle-o"></i> <span>结算记录</span> </a></li>
            </ul>
          </li>
             <li class="treeview <?=isActive(array('zero', 'lab','area','rsync','cancle'))?>">
              ...
              <ul class="treeview-menu">
                <li class="<?=isActive('zero')?>"><a href="/myba/zero"><i class="fa fa-circle-o"></i> <span>积分清零</span> </a></li>
                <?php if($_SESSION['myba']['admin'] >= 1):?>
                <li class="<?=isActive('hb_check')?>"><a href="/myba/hb_check"><i class="fa fa-circle-o"></i> <span>红包发送审核</span> </a></li>
                <?php endif?>
              </ul>
            </li>
            <?php if($_SESSION['myba']['admin'] >= 1):?>
              <li class="<?=isActive('admin')?>"><a href="/myba/logins"><i class="fa fa-user"></i> <span>账号管理</span></a></li>
            <?php endif?>
