...
<form method="get" name="loginsform">
  ...
  <div class="row">
    <div class="col-xs-12">
      <a href="/flba/logins/add" class="btn btn-success pull-right" style="margin-right:10px;margin-bottom:10px"> <i class="fa fa-plus"></i> &nbsp; <span>添加新用户</span></a>
    </div>
  </div>
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                foreach ($result['logins'] as $login):
                  //按账号统计
                  $biz_name = ORM::factory('flb_cfg')->where('bid', '=', $login->id)->where('key', '=', 'name')->find()->value;

                  $count_all = ORM::factory('flb_qrcode')->where('bid', '=', $login->id)->count_all();
                ...
                <tr>
                  ...
                  <td><a href="/flba/logins/edit/<?=$login->id?>"><span>修改</span> <i class="fa fa-edit"></i></a></td>
                </tr>
