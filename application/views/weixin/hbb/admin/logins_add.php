...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="/hbba/items">账号管理</a></li>
      ...
      <div class="row">
        <div class="col-lg-5">
          <div class="form-group">
            ...
            <input type="text" maxlength="20" class="form-control" id="num" name="data[num]" placeholder="" value="<?=trim($_POST['data']['num'])?>">
          </div>
        </div>
      </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="/hbba/items/edit/<?=$result['item']['id']?>?DELETE=1" class="btn btn-outline">确认删除</a>
      </div>
