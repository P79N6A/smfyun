    ...
    <table class="table table-striped">
      ...
      <table class="table table-striped table-hover" style="background-color: #fff;">
        ...
        <tbody>
                ...
                ?>
               <?php
                  $information=ORM::factory('hbb_weixinsatu')->where('mch_billno','=',$orders->mch_billno)->find();
                  $koulintype=ORM::factory('hbb_kl')->where('code','=',$orders->kouling)->where('bid','=',$orders->bid)->find()->split;
