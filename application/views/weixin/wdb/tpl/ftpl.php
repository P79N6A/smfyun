<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="http://cdn.jfb.smfyun.com/wdb/front/css/ui.css?v<?=date('Ymd')?>">
    <link rel="stylesheet" type="text/css" href="http://cdn.jfb.smfyun.com/wdb/front/css/style.css?v<?=date('Ymd')?>">
  <!-- Gem style -->
  </head>

  <script src="http://cdn.jfb.smfyun.com/wdb/plugins/jQuery/jQuery-2.1.4.min.js"></script>
    ...
    <div class="wrp">
      ...
      <div class="profile_fun">
            ...
            <ul id="js_menu" class="menu_list">
                <? if(Session::instance()->get('wdb')["bid"]==582):?>
                <li class="menu_item fans_record" style="width:50%">
                    <a href="/wdb/score" class="inner_item">
                ...
                <li class="menu_item rank_record" style="width:50%">
                    <a href="/wdb/top" class="inner_item">
                        <span class="icon_menu"></span>
              ...
              <? else:?>
                ...
                <li class="menu_item swap_record">
                    <a href="/wdb/items" class="inner_item">
                        <span class="icon_menu"></span>
