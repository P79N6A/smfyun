        ...
        <div class="tab-content">
            ...
            <form role="form" method="post" enctype='multipart/form-data'>
              ...
              <div class="form-group">
                ...
                <?php if($user->refresh_token):?>
                  <a href='https://mp.weixin.qq.com/cgi-bin/componentloginpage?component_appid=wx82bbedde01616555&pre_auth_code=<?=$pre_auth_code?>&redirect_uri=http://<?=$_SERVER["HTTP_HOST"]?>/wdba/home'><button type="button" class="btn btn-warning">点击重新授权</button></a>
                <?php else:?>
                  <a href='https://mp.weixin.qq.com/cgi-bin/componentloginpage?component_appid=wx82bbedde01616555&pre_auth_code=<?=$pre_auth_code?>&redirect_uri=http://<?=$_SERVER["HTTP_HOST"]?>/wdba/home'><button type="button" class="btn btn-warning">点击一键授权</button></a>
                <?php endif?>
                </div>
                <div class="form-group">
          ...
          <div class="tab-pane" id="cfg_text">
            ...
            <form role="form" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                if ($result['tpl']):
                  ?>
                <div class="form-group">
                  <a href="/wdba/images/cfg/<?=$result['tpl']?>.v<?=time()?>.jpg" target="_blank"><img class="img-thumbnail" src="/wdba/images/cfg/<?=$result['tpl']?>.v<?=time()?>.jpg" width="200" title="点击查看原图"></a>
                </div>
              <?php endif?>
              ...
              <div class="form-group">
                ...
                <p class="help-block">只能为 JPEG 格式，规格建议为 640*900px，最大不超过 300K，<a href="/wdb/tpl.zip" target="_blank">点击这里</a> 下载 PSD 模板自行设计。</p>
              </div>
              ...
              if ($result['tplhead']):
                ?>
              <div class="form-group">
                <a href="/wdba/images/cfg/<?=$result['tplhead']?>.v<?=time()?>.jpg" target="_blank"><img class="img-thumbnail" src="/wdba/images/cfg/<?=$result['tplhead']?>.v<?=time()?>.jpg" width="100" title="点击查看原图"></a>
              </div>
            <?php endif?>
            ...
            <div class="form-group">
              ...
              <p class="help-block">建议设置为活动说明的页面</p>
            </div>
            ...
            <div class="tab-pane" id="cfg_zero">
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          ...
                          <a href="<?php echo URL::site("wdba/empty")?>?DELETE=1" class="btn btn-outline">确认清空</a>
                        </div>
                      </div><!-- /.modal-content -->
                    </div><!-- /.modal-dialog -->
                  </div><!-- /.modal -->
              ...
              <div class="tab-pane" id="cfg_area">
                ...
                <!-- // <script src="/wdb/plugins/jQuery/jquery.js"></script> -->
                <script src="http://cdn.jfb.smfyun.com/wdb/plugins/citySelect/jquery.cityselect.js"></script>
                <script src="/wdb/plugins/citySelect/city.min1.js"></script>
                <script type="text/javascript">
                  $("#city1").citySelect({
                    prov:'',
                    city:'',
