 ...
 * @param {Function} callback 回调函数
 */
exports.sendTemplate = function (openid, templateId, url, data,miniprogram, callback, callback2) {
  this.preRequest(this._sendTemplate, arguments);
};

exports._sendTemplate = function (openid, templateId, url, data,miniprogram,callback, callback2) {
  /*
      duplicated interface `function (openid, templateId, url, topColor, data, callback)`
   */
   console.log('this.token.accessToken::::'+this.token.accessToken);
